<body>
    ...
    if (isset($_REQUEST['id']) && $_REQUEST['act'] == "set") {
        ...
        header("Location: files/ManageServiceReq2.php");
    }
    ...
    $result2 = mysql_query("select * from table_servicereq where Ind = '1' AND Status = 'Approval' AND DivUnitRPO = '$dur' order by Id desc LIMIT 10");
    ...
    while ($extract2 = mysql_fetch_array($result2)) {
      ...
      <li>
      <a class="a" href="../notif4.php?id=' . $extract2['Id'] . '&act=set">
      <h4>
      ' . $extract2['ReqBy'] . '
