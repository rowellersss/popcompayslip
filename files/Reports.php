                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" class="body">
                                <div style="height: auto; right: 0; width: auto; padding: 40px;">
                                            ...
                                            <tbody >
                                                ...
                                                if (isset($_POST['process'])) {
                                                    ...
                                                    if (!empty($d1) && !empty($d2) && empty($d3) && empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Approved' AND DateofReq BETWEEN '$start' AND '$end' order by Id asc");
                                                    }
                                                    if (empty($d1) && empty($d2) && !empty($d3) && empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Approved' AND DivUnitRPO = '$d3' order by Id asc");
                                                    }
                                                    if (empty($d1) && empty($d2) && empty($d3) && !empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Approved' AND Category = '$d4' order by Id asc");
                                                    }
                                                    if (!empty($d1) && !empty($d2) && !empty($d3) && !empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Approved' AND DateofReq BETWEEN '$start' AND '$end' AND DivUnitRPO = '$d3' AND Category = '$d4' order by Id asc");
                                                    }
                                                    if (!empty($d1) && !empty($d2) && !empty($d3) && empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Approved' AND DateofReq BETWEEN '$start' AND '$end' AND DivUnitRPO = '$d3' order by Id asc");
                                                    }
                                                    if (empty($d1) && empty($d2) && !empty($d3) && !empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Approved' AND DivUnitRPO = '$d3' AND Category = '$d4' order by Id asc");
                                                    }
                                                    if (!empty($d1) && !empty($d2) && empty($d3) && !empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Approved' AND DateofReq BETWEEN '$start' AND '$end' AND Category = '$d4' order by Id asc");
                                                    }
                                                    if (empty($d1) && empty($d2) && empty($d3) && empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Approved' order by Id asc");
                                                    }
                                                }
                                                ...
                                                while ($row = mysql_fetch_array($query2)) {
                                                    ...
                                                    if ($row['Category'] == "") {
                                                        $cat2 = "Not yet finished";
                                                    } else {
                                                        $cat2 = $row['Category'];
                                                    }

                                                    echo '<tr><td>' . ucwords($row['ReqBy']) . '</td><td>' . $date . '</td><td>' . $row['DivUnitRPO'] . '</td>'
                                                    . '<td style="max-width: 200px;">' . $row['DescOfReq'] . '</td><td>' . $cat2 . '</td></tr>';
                                                }
                                                ?>
                                            </tbody>
                                        </table>
