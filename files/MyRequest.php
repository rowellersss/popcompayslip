                            ...
                            <div style="min-height: 80vh; background-color: #fff;" class="body">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $query2 = mysql_query("select * from table_servicereq where Emp_Id = '$empid2' order by DateofReq desc");
                                        while ($row = mysql_fetch_array($query2)) {
                                            ...
                                            echo '<tr><td>' . $row['Id'] . '</td><td>' . $date . '</td><td>' . $row['TimeOfReq'] . '</td><td>' . $row['DivUnitRPO'] . '</td>'
                                            . '<td style="max-width: 200px;">' . $row['DescOfReq'] . '</td>'
                                            . '<td style="color:' . $color . '"><b>' . $row['Status'] . '</b></td>'
                                            . '<td><a title="Survey" href="Survey.php?Id=' . $row['Id'] . '&act=set"><i class="material-icons">assignment</i></a></td></tr>';
                                        }
                                        //<a href="../RequestForm.php?Id=' . $row['Id'] . '&act=set"><i class="material-icons">visibility</i></a>
                                        ?>
