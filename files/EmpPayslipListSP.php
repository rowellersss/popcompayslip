                        ...
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" id="bodyy" class="body">
                                <div style="height: 730px; right: 0; width: auto; padding: 40px;">
                                    ...
                                    <div id="sap">
                                        <form action="EmpPayslipListSP.php?id=<?php echo $_GET['id']; ?>" method="post" id="paySlipForm">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-2 col-sm-2 col-md-2 col-lg-7">
                                                    <div id="date1">
                                                        ...
                                                        <input type="hidden" name="empid" value="<?php echo $_REQUEST['id'];?>">
<!--                                                    <select name="day" id="day" required>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                                    ...
                                                    if (isset($datefirst)) {
                                                        ...
                                                        $sql1 = mysql_query("select * from table_specialpayroll where Emp_no = '$empidd' AND In_date = '$datefirst'");
                                    ...
                                    <div id="his" style="width: 900px; margin: 0 auto;">
                                        <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                            ...
                                            <tbody>
                                                ...
                                                $query = mysql_query("SELECT * FROM table_specialpayroll WHERE Emp_no = $empno ORDER BY year_covered AND month_covered asc");
                                                while ($row = mysql_fetch_array($query)) {
                                                    $date_covered = $year_covered. '-' .$month_covered;
                                                    echo '<tr>';
                                    ...
                                    <?php
                                    $empid = $_SESSION['INTRA_EMP_ID'];
                                    $sql = mysql_query("Select * from table_specialpayroll where Emp_no = '$empid'");
                        ...
                        if (numcount == 0) {
                            ...
                            if ($('#year').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    ...
                                    newTab.location = "ViewPayslipSP.php?cat=" + $('#cat').val() + "&Mdate=" + $('#year').val() + "-" + $('#month').val() + "-01&id=" + <?php echo $_GET['id']; ?>;
                                }
                            } else if ($('#year2').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    newTab.close();
                                    ...
                                    //ViewPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    newTab.location = "ViewPayslipSP.php?cat=" + $('#cat').val() + "&Adate=" + $('#year2').val() + "&id=" + <?php echo $_GET['id']; ?>;
                                }
                            } else if ($('#year3').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    newTab.close();
                                    ...
                                    //ViewPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    newTab.location = "ViewPayslipSP.php?cat=" + $('#cat').val() + "&Ydate=" + $('#year3').val() + "-01-01&Ydate2=" + $('#year3').val() + '-' + $('#month3').val() + "-01&id=" + <?php echo $_GET['id']; ?>;
                                }
                            } else if ($('#year4').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    newTab.close();
                                    ...
                                    //ViewPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    newTab.location = "ViewPayslipSP.php?cat=" + $('#cat').val() + "&Rdate=" + $('#year4').val() + '-' + $('#month4').val() + '-01&Rdate2=' + $('#year4').val() + '-' + $('#month41').val() + '-01&id=' + <?php echo $_GET['id']; ?>;
                                }
                            }
