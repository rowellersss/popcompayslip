...
<html lang="en-US">
    ...
    <body class="theme-red zoom90" style="background-color: #4caf50;">
        <!-- Page Loader -->
        ...
        <nav class="navbar" style="background-color: #0d501b;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <span style="margin-left: 17%;"><img src="../images/popcomlogo2.png"></span>
                </div>
        ...
        <section>
            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="menu">
                    ...
                    <div id="offline" style="margin-bottom: 20px;">
                ...
                <div class="row clearfix">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    ...
                                    if (isset($_SESSION['INTRA_CID'])) {
                                        ...
                                        $query = mysql_query("select * from table_empinfo where Id = '$cid'");
                            ...
                            <div style="min-height: 80vh; background-color: #f6f6f6;" id="bodyy" class="body">
                                <form name="form1">

                                    <div id="chatlogs" class="chatbody">
                                        <img src="../images/1-0.gif">
                                    </div>
                                    <textarea class="chatboxM" name="msg" placeholder="Message here..."></textarea><br><br>
                                    <button class="chatbutton" type="button" onclick="submitChat()"><i class="material-icons">send</i></button>
        ...
        <script type="text/javascript">
            ...
            function ScrollToBottom() {
                var d = document.getElementById("chatlogs");
                d.scrollTop = d.scrollHeight;
            }

            $(window).resize(function () {
                $('#bodyy').height($(window).height() - 240);
            });
            $(window).resize(function () {
                $('#chatlogs').height($(window).height() - 420);
            });
