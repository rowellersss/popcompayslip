    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#radio2,#radio3,#radio5,#radio6,#vacaDiv,#sickDiv,#wd,#text1,#text2,#text3,#text4,#text5').hide();
                $('#vacaLeave').click(function () {
                    $('#radio2,#radio3,#vacaDiv,#wd').show();
                    $('#radio5,#radio6,#sickDiv').hide();
                });
                $('#sickLeave').click(function () {
                    $('#radio5,#radio6,#sickDiv,#wd').show();
                        ...
                        <div class="card">
                            <div class="header">
                                <h2>
                                    ...
                                    <?php
                                    /* if (isset($_SESSION['INTRA_CID'])) {MATERNITY
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" class="body">
                                <div style="min-height: 77vh;right: 0; width: auto; padding: 40px;">
                                    <form action="LeaveApplicationList.php" method="post">
                                        <input type="submit" name="btnCreate" value="Create New Application for Leave"  class="btn bg-indigo waves-effect"><br><br><br>
                                    </form>
                                    <?php
                                    $query = mysql_query("SELECT * FROM table_leaveapplication WHERE Pds_Id = '$pdsid' ORDER BY Date_offiling desc");
                                    while ($row = mysql_fetch_array($query)) {
                                        echo '<a href="ViewLeaveApplication.php?trac_no=' . md5($row['Transaction_no']) . '" target="_blank">' . 'Document No. ' . $row['Transaction_no'] . ' / ' . $row['Type'] . ' Leave / ' . $row['Date_offiling'] . '</a><br><br>';
                                    }
                                    ?>
                                </div>
                            </div>
