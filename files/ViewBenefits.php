                        ...
                        <div class="card">
                            ...
                            <div style="background-color: #fff; min-height: 80vh;" class="body">
                                ...
                                $date = explode('-', $datee);
                                    ...
                                    if($benefits == 'longevity_pay'){
                                        echo '<p style="font-weight: bold; font-size: 18px; text-align: center;">Longevity Pay ' . $month . ' ' . $date[0] . '</p>';
                                    }else if($benefits == 'hazard_pay'){
                                        echo '<p style="font-weight: bold; font-size: 18px; text-align: center;">Hazard Pay ' . $month . ' ' . $date[0] . '</p>';
                                    }else if($benefits == 'sublau'){
                                        echo '<p style="font-weight: bold; font-size: 18px; text-align: center;">Subsistence and Laundry ' . $month . ' ' . $date[0] . '</p>';
                                    }
                                    echo '<br><br>';
                                    echo '<a class="btn bg-teal btn-md waves-effect" href="ViewBenefits.php?benefits=longevity_pay&date=' . $datee . '">Longevity</a>&nbsp';
                                    echo '<a class="btn bg-teal btn-md waves-effect" href="ViewBenefits.php?benefits=hazard_pay&date=' . $datee . '">Hazard</a>&nbsp';
                                    echo '<a class="btn bg-teal btn-md waves-effect" href="ViewBenefits.php?benefits=sublau&date=' . $datee . '">Subsistence and Laundry</a>';
                                ?>
                                <br><br>
                                <table id="example" class="table-bordered stripe row-border order-column" cellspacing="0" width="100%">
                                    ...
                                    <thead>
                                        ...
                                        {
                                            echo '<tr>';
                                                echo '<th rowspan="2">Employee No.</th>';
                                                echo '<th rowspan="2">Name</th>';
                                                echo '<th rowspan="2">Position</th>';
                                                echo '<th rowspan="2">Date Covered</th>';
                                                echo '<th colspan="3">Longevity</th>';
                                        ...
                                        else if($benefits == 'sublau')
                                        {
                                            echo '<tr>';
                                                ...
                                                echo '<th rowspan="2">Position</th>';
                                                echo '<th rowspan="2">Date Covered</th>';
                                                echo '<th colspan="4">Subsistence and Laundry</th>';
                                                echo '<th rowspan="2">Action</th>';
                                            echo '</tr>';
                                            echo '<tr>';
                                                echo '<th>Subsistence </th>';
                                                echo '<th>Laundry</th>';
                                                echo '<th>PMPC</th>';
                                                echo '<th>Withtax</th>';
                                            echo '</tr>';
                                    ...
                                    <tbody class="body">
                                        ...
                                        $dcov = $datee.'-01';
                                        if($benefits == 'longevity_pay'){
                                            $query2 = mysql_query("SELECT Date_covered, Emp_no, Name, Position, Longevity_pay, Longevity_pmpc, Longevity_withtax FROM table_otherbenefits WHERE Longevity_date LIKE '$datee%'");
                                            ...
                                            while ($row = mysql_fetch_array($query2)) {
                                                ...
                                                $monthcov = explode('-', $row['Date_covered']);
                                                echo '<td>' . date('F, Y', mktime(null, null, null, $monthcov[1], 1)) . '</td>';
                                                echo '<td>' . $row['Longevity_pay'] . '</td>';
                                                echo '<td>' . $row['Longevity_pmpc'] . '</td>';
                                                echo '<td>' . $row['Longevity_withtax'] . '</td>';
                                                
                                                echo '<td>';
                                                echo '<a class="btn bg-light-green btn-xs waves-effect" data-emp="' . $row['Emp_no'] . '" href="ViewPayslip.php?cat=Benefits&Mdate=' . $dcov . '&id=' . $row['Emp_no'] . '" target="_blank">View</a>';
                                                echo '</td>';
                                                echo '</tr>';
                                            }

                                        }else if($benefits == 'hazard_pay'){
                                            $query2 = mysql_query("SELECT Date_covered, Emp_no, Name, Position, Hazard_pay, Hazard_pmpc, Hazard_copea, Hazard_withtax FROM table_otherbenefits WHERE Hazard_date LIKE '$datee%'");
                                            ...
                                            while ($row = mysql_fetch_array($query2)) {
                                                ...
                                                echo '<td>' . $row['Hazard_pmpc'] . '</td>';
                                                echo '<td>' . $row['Hazard_copea'] . '</td>';
                                                echo '<td>' . $row['Hazard_withtax'] . '</td>';
                                            ...
                                            $query2 = mysql_query("SELECT Date_covered, Emp_no, Name, Position, Subsistence_allowance, Laundry_allowance, Sublau_pmpc, Sublau_withtax FROM table_otherbenefits WHERE Sublau_date LIKE '$datee%'");
                                            ...
                                            while ($row = mysql_fetch_array($query2)) {
                                                ...
                                                echo '<td>' . $row['Sublau_pmpc'] . '</td>';
                                                echo '<td>' . $row['Sublau_withtax'] . '</td>';
        ...
        $(document).ready(function () {
            ...
            $('#example').on('click', 'a.confirmme', function (e) {
                ...
                function () {
                    $.ajax({
                        type: 'POST',
                        url: 'ViewBenefits.php?emp=' + emp + '&date=' + date + '&date_ben='+ for_benefits + '&key='+ key +'&act=app',
                        success: function () {
                            $('#example').attr("id");
