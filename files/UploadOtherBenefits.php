        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            UPLOAD OTHER BENEFITS
                            <small>UPLOAD CSV FILE</small>
                        </h2>
                        <div class="body" style="min-height: 77vh;">

                            <form id="upload-benefits" method="POST" enctype="multipart/form-data" style="margin-top: 80px;">

                                <br>
                                <label for="bene">Benefits: </label>
                                <select name="bene" id="bene" required>
                                    <option value="">---</option>
                                    <option value="pera">P.E.R.A</option>
                                    <option value="lon">Longevity Pay</option>
                                    <option value="haz">Hazard Pay</option>
                                    <option value="sublau">Subsistence and Laundry</option>
                                </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <label for="year">Year Covered: </label>
                                ...
                                <label for="month">Month Covered: </label>
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                        <div style="width: 200px;" class="form-group">
                                            <div class="form-line">
                                                <label for="bdate">Date Uploaded: </label>
                                                <input type="text" name="bdate" id="bdate" class="datepicker form-control" placeholder="Please choose a date..." required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <div align="center">
                                    <h3><p style="text-align: center;" id="lon">Longevity Pay<br></p></h3>
                                    <h3><p style="text-align: center;" id="haz">Hazard Pay<br></p></h3>
                                    <h3><p style="text-align: center; padding-bottom: 10px;" id="sublau">Subsistence and Laundry Allowance</p></h3>
                                    <div id="fade"></div>
                                    <input type="file" name="file" class="filee"><br>
                                    <input type="submit" name="btnSubmit" value="Import" class="btn bg-blue-grey waves-effect">
                                </div>
                            </form>
