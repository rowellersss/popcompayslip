...
if (isset($_REQUEST['emp']) && $_REQUEST['act'] == 'app') {
    ...
    mysql_query("UPDATE table_otherbenefits SET Longevity_Status = 1 WHERE Emp_no = '$emp' AND Longevity_date = '$date'");
} elseif (isset($_REQUEST['emp']) && $_REQUEST['act'] == 'app1') {
    $emp = $_REQUEST['emp'];
    $date = $_REQUEST['date'];

    mysql_query("UPDATE table_otherbenefits SET Hazard_Status = 1 WHERE Emp_no = '$emp' AND Hazard_date = '$date'");
} elseif (isset($_REQUEST['emp']) && $_REQUEST['act'] == 'app2') {
    $emp = $_REQUEST['emp'];
    $date = $_REQUEST['date'];

    mysql_query("UPDATE table_otherbenefits SET Sublau_Status = 1 WHERE Emp_no = '$emp' AND Sublau_date = '$date'");
}
?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div style="background-color: #fff; min-height: 80vh;" class="body">
                                <br>
                                <a class="btn bg-teal btn-md waves-effect" href="VerifiedOBData.php" target="_blank">View Verified Data</a><br><br>
                                ...
                                <div id="lon">
                                    ...
                                    <table id="example" class="example table-bordered stripe row-border order-column" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysql_query("SELECT A.*, B.* FROM table_otherbenefits A"
                                                    ...
                                                    . "     ON A.Emp_no = B.Employee_Id WHERE Date_covered = '$datee'");
                                            ...
                                            while ($row = mysql_fetch_array($query)) {
                                                ...
                                                echo '</td>';
                                                echo '<td>';
                                                if ($row['Longevity_Status'] == '1' || $row['Longevity_Status'] == '2') {
                                                    echo '<i class="material-icons" style="color: green;">check_circle</i>';
                                                } else {
                                    ...
                                    <br>
                                    <input type="button" class="btn bg-teal btn-md waves-effect" onclick="location.href = 'OBList.php';" value=" Back " />
                                </div>
                                <div id="haz">    
                                    <?php
                                    echo '<p style="font-weight: bold; font-size: 18px; text-align: center;"> Hazard Pay - ' . date('F, Y', strtotime($datee)) . '</p><br>';
                                    ?>
                                    <table id="example1" class="example table-bordered stripe row-border order-column" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysql_fetch_array($query1)) {
                                                ...
                                                echo '</td>';
                                                echo '<td>';
                                                if ($row['Hazard_Status'] == '1' || $row['Hazard_Status'] == '2') {
                                                    echo '<i class="material-icons" style="color: green;">check_circle</i>';
                                                } else {
                                ...
                                <div id="sublau">
                                    <?php
                                    echo '<p style="font-weight: bold; font-size: 18px; text-align: center;"> Subsistence and Laundry Allowance - ' . date('F, Y', strtotime($datee)) . '</p><br>';
                                    ?>
                                    <table id="example2" class="example table-bordered stripe row-border order-column" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysql_fetch_array($query2)) {
                                                ...
                                                echo '</td>';
                                                echo '<td>';
                                                if ($row['Sublau_Status'] == '1' || $row['Sublau_Status'] == '2') {
                                                    echo '<i class="material-icons" style="color: green;">check_circle</i>';
                                                } else {
                ...
                function () {
                    ...
                    if ($('#bene').val() === 'lon') {
                        $.ajax({
                            ...
                            success: function () {
                                $('#example').attr("id");
                                a.closest('td').html('<i class="material-icons" style="color: green;">check_circle</i>');
