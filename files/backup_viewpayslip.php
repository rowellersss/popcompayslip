...
// <!--<link href="../../IntranetF/css/style11.css" rel="stylesheet" type="text/css"/>-->
...
if (!isset($_REQUEST['empid'])) {
    ...
    if (isset($_REQUEST['Mdate'])) {
        ...
        $sql2 = mysql_query("SELECT * FROM table_otherbenefits WHERE Emp_no = '$empid' AND Longevity_date LIKE '$date_covered%' AND Hazard_date LIKE '$date_covered%' AND Sublau_date LIKE '$date_covered%'");
        ...
        $sql2 = mysql_query("SELECT *, FORMAT(SUM(REPLACE(Longevity_pay, ',','')), 2)AS Longevity_pay,
                            ...
                            WHERE Emp_no = '$empid'
                            AND Longevity_Status = 1
                            AND Hazard_Status = 1
                            AND Sublau_Status = 1
                            AND Longevity_date LIKE '$year%'
                            AND Hazard_date LIKE '$year%'
                            AND Sublau_date LIKE '$year%'");
...
//$html .= '<tr><td style="border-top: 2px solid black;"><b>Net Amount Due</b></td><td style="border-top: 2px solid black;"><b>' . number_format(str_replace(' ', '', $row['Net_amount']), 2) . '</b></td></tr>';
        ...
        if ($_REQUEST['cat'] == 'Summary') { //$num != 0 &&
            ...
            if($numrowsLngvty >  1){
                ...
                if($_REQUEST['Mdate']){
                    $html .= '<tr><td colspan="2" class="tdfont">Longevity Pay - '.date('M. Y', strtotime($row2['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . ($row2['Longevity_Status'] != 0 ? number_format(str_replace(' ', '', $lon), 2) : "") . '</td></tr>';
                    $lonPay = str_replace(',', '', $lngvty['Longevity_pay']);
                }elseif($_REQUEST['Adate']){
                    $html .= '<tr><td colspan="2" class="tdfont">Longevity Pay</td><td colspan="2" class="tdfont" style="text-align: right;">' . ($row2['Longevity_Status'] != 0 ? number_format(str_replace(' ', '', $lon), 2) : "") . '</td></tr>';
                }
            }
            if($numrowsHzrd > 1){
                ...
                if($_REQUEST['Mdate']){
                    $html .= '<tr><td colspan="2" class="tdfont">Hazard Pay - '.date('M. Y', strtotime($row2['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . ($row2['Hazard_Status'] != 0 ? number_format(str_replace(' ', '', $haz), 2) : "") . '</td></tr>';
                    $hazPay = str_replace(',', '', $hzrd['Hazard_pay']);    
                }elseif($_REQUEST['Adate']){
                    $html .= '<tr><td colspan="2" class="tdfont">Hazard Pay</td><td colspan="2" class="tdfont" style="text-align: right;">' . ($row2['Hazard_Status'] != 0 ? number_format(str_replace(' ', '', $haz), 2) : "") . '</td></tr>';
                }
            }
            if($numrowsSl > 1){
                ...
                $sl = $s + $l;
                if($_REQUEST['Mdate']){
                    $html .= '<tr><td colspan="2" class="tdfont">Subs. & Laund. - '.date('M. Y', strtotime($row2['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . ($row2['Sublau_Status'] != 0 ? number_format(str_replace(' ', '', $sl), 2) : "") . '</td></tr>';
                    $sLpay = $sl;
                }elseif($_REQUEST['Adate']){
                    $html .= '<tr><td colspan="2" class="tdfont">Subsistence/Laundry Allowance</td><td colspan="2" class="tdfont" style="text-align: right;">' . ($row2['Sublau_Status'] != 0 ? number_format(str_replace(' ', '', $sublau), 2) : "") . '</td></tr>';
                }
            }
            $grTotal = $lonPay1 + $hazPay1 + $sLpay1 + $pera + $bonusesTotal;
            ...
            if($_REQUEST['Mdate'] OR $_REQUEST['Adate']){
                $html .= '</tr><tr>';
                $html .= '<td colspan="4" class="tdfont">Others:</td>';
                $html .= '</tr><tr>';
                $html .= '</tr>';
...
// //             }
// // //            $html .= '</tr><tr>';
// //             $html .= '<td colspan="2" class="tdfont">Withholding Tax & Others</td><td colspan="2" class="tdfont"></td>';
// //             $html .= '</tr>';
// //             //----------------Longevity----------------//
// //             $lonsum = 0;
// //             for ($i = 0; $i < $londeduCount; $i++) {
...
//             $nthpOfficial = $naT + $nobOfficial;
        ...
        // if($numrows2 > 1)
        // {
        //     while($dataTax = mysql_fetch_assoc($sql2))
        //     {
        //         $lonPmpc += ($dataTax['Longevity_Status'] != 0 ? (!empty($dataTax['Longevity_pmpc']) ? str_replace(',', '', $dataTax['Longevity_pmpc']) : 0.00) : "");
        //         $lonWTax += ($dataTax['Longevity_Status'] != 0 ? (!empty($dataTax['Longevity_withtax']) ? str_replace(',', '', $dataTax['Longevity_withtax']) : 0.00) : "");
        //         $hazPmpc += ($dataTax['Hazard_Status'] != 0 ? (!empty($dataTax['Hazard_pmpc']) ? str_replace(',', '', $dataTax['Hazard_pmpc']) : 0.00) : "");
        //         $hazCopea += ($dataTax['Hazard_Status'] != 0 ? (!empty($dataTax['Hazard_copea']) ? str_replace(',', '', $dataTax['Hazard_copea']) : 0.00) : "");
        //         $hazWTax += ($dataTax['Hazard_Status'] != 0 ? (!empty($dataTax['Hazard_withtax']) ? str_replace(',', '', $dataTax['Hazard_withtax']) : 0.00) : "");
        //         $sublauPmpc += ($dataTax['Sublau_Status'] != 0 ? (!empty($dataTax['Sublau_pmpc']) ? str_replace(',', '', $dataTax['Sublau_pmpc']) : 0.00) : "");
        //         $sublauWTax += ($dataTax['Sublau_Status'] != 0 ? (!empty($dataTax['Sublau_withtax']) ? str_replace(',', '', $dataTax['Sublau_withtax']) : 0.00) : "");
        //     }
        // }
        // else
        // {
        //     $lonPmpc = ($row2['Longevity_Status'] != 0 ? (!empty($row2['Longevity_pmpc']) ? str_replace(',', '', $row2['Longevity_pmpc']) : 0.00) : "");
        //     $lonWTax = ($row2['Longevity_Status'] != 0 ? (!empty($row2['Longevity_withtax']) ? str_replace(',', '', $row2['Longevity_withtax']) : 0.00) : "");
        //     $hazPmpc = ($row2['Hazard_Status'] != 0 ? (!empty($row2['Hazard_pmpc']) ? str_replace(',', '', $row2['Hazard_pmpc']) : 0.00) : "");
        //     $hazCopea = ($row2['Hazard_Status'] != 0 ? (!empty($row2['Hazard_copea']) ? str_replace(',', '', $row2['Hazard_copea']) : 0.00) : "");
        //     $hazWTax = ($row2['Hazard_Status'] != 0 ? (!empty($row2['Hazard_withtax']) ? str_replace(',', '', $row2['Hazard_withtax']) : 0.00) : "");
        //     $sublauPmpc = ($row2['Sublau_Status'] != 0 ? (!empty($row2['Sublau_pmpc']) ? str_replace(',', '', $row2['Sublau_pmpc']) : 0.00) : "");
        //     $sublauWTax = ($row2['Sublau_Status'] != 0 ? (!empty($row2['Sublau_withtax']) ? str_replace(',', '', $row2['Sublau_withtax']) : 0.00) : "");
        // }
        ...
        if($numrowsLngvty > 1){
            while($lngvty = mysql_fetch_assoc($longevity1B_a)){
                $html .= ($lngvty['Longevity_Status'] != 0 && $lngvty['Longevity_pmpc'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Longevity PMPC - '.date('M. Y', strtotime($lngvty['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . $lngvty['Longevity_pmpc'] . '</td>' : '');
            }
            while($lngvty = mysql_fetch_assoc($longevity1B_b)){   
                $html .= ($lngvty['Longevity_Status'] != 0 && $lngvty['Longevity_withtax'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Longevity W/Tax - '.date('M. Y', strtotime($lngvty['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . $lngvty['Longevity_withtax'] . '</td>' : '');
            }
        }else{
            if($_REQUEST['Mdate']){
                $html .= ($row2['Longevity_Status'] != 0 && $row2['Longevity_pmpc'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Longevity PMPC - '.date('M. Y', strtotime($row2['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Longevity_pmpc'] . '</td>' : '');
                $html .= ($row2['Longevity_Status'] != 0 && $row2['Longevity_withtax'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Longevity W/Tax - '.date('M. Y', strtotime($row2['Date_covered'])).' </td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Longevity_withtax'] . '</td>' : '');
            }elseif($_REQUEST['Adate']){
                $html .= ($row2['Longevity_Status'] != 0 && $row2['Longevity_pmpc'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Longevity PMPC</td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Longevity_pmpc'] . '</td>' : '');
                $html .= ($row2['Longevity_Status'] != 0 && $row2['Longevity_withtax'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Longevity W/Tax</td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Longevity_withtax'] . '</td>' : '');
            }
        }
        if($numrowsHzrd > 1){
            while($hzrd = mysql_fetch_assoc($hazard1B_a)){
                $html .= ($hzrd['Hazard_Status'] != 0 && $hzrd['Hazard_pmpc'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Hazard PMPC - '.date('M. Y', strtotime($hzrd['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . $hzrd['Hazard_pmpc'] . '</td></tr>' : '');
            }
            while($hzrd = mysql_fetch_assoc($hazard1B_b)){
                $html .= ($hzrd['Hazard_Status'] != 0 && $hzrd['Hazard_copea'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Hazard COPEA - '.date('M. Y', strtotime($hzrd['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . $hzrd['Hazard_copea'] . '</td></tr>' : '');
            }
            while($hzrd = mysql_fetch_assoc($hazard1B_c)){
                $html .= ($hzrd['Hazard_Status'] != 0 && $hzrd['Hazard_withtax'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Hazard W/Tax - '.date('M. Y', strtotime($hzrd['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . $hzrd['Hazard_withtax'] . '</td></tr>' : '');
            }
        }else{
            if($_REQUEST['Mdate']){
                $html .= ($row2['Hazard_Status'] != 0 && $row2['Hazard_pmpc'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Hazard PMPC - '.date('M. Y', strtotime($row2['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Hazard_pmpc'] . '</td></tr>' : '');
                $html .= ($row2['Hazard_Status'] != 0 && $row2['Hazard_copea'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Hazard COPEA - '.date('M. Y', strtotime($row2['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Hazard_copea'] . '</td></tr>' : '');
                $html .= ($row2['Hazard_Status'] != 0 && $row2['Hazard_withtax'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Hazard W/Tax - '.date('M. Y', strtotime($row2['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Hazard_withtax'] . '</td></tr>' : '');
            }elseif($_REQUEST['Adate']){
                $html .= ($row2['Hazard_Status'] != 0 && $row2['Hazard_pmpc'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Hazard PMPC</td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Hazard_pmpc'] . '</td></tr>' : '');
                $html .= ($row2['Hazard_Status'] != 0 && $row2['Hazard_copea'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Hazard COPEA</td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Hazard_copea'] . '</td></tr>' : '');
                $html .= ($row2['Hazard_Status'] != 0 && $row2['Hazard_withtax'] != '' ? '<tr><td colspan="2" class="tdfont" stye="font-size: 9px;">Hazard W/Tax</td><td colspan="2" class="tdfont" style="text-align: right;">' . $row2['Hazard_withtax'] . '</td></tr>' : '');
            }
        }
        if($numrowsSl > 1){
        ...
        if ($_REQUEST['cat'] == 'Summary') { //$num != 0 &&
            ...
            if($numrowsSl > 1){
                while($sL = mysql_fetch_assoc($subslaund2A)){
                    $html .= '<tr><td colspan="2" class="tdfont">Subs. & Laund. - '.date('M. Y', strtotime($sL['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . ($sL['Sublau_Status'] != 0 ? number_format(str_replace(' ', '', $sublau), 2) : "") . '</td></tr>';
                    $sLpay += $sublau;
                }
            }else{
                if($_REQUEST['Mdate']){
                    $html .= '<tr><td colspan="2" class="tdfont">Subs. & Laund. - '.date('M. Y', strtotime($row2['Date_covered'])).'</td><td colspan="2" class="tdfont" style="text-align: right;">' . ($row2['Sublau_Status'] != 0 ? number_format(str_replace(' ', '', $sublau), 2) : "") . '</td></tr>';
                    $sLpay = $sublau;
                }elseif($_REQUEST['Adate']){
                    $html .= '<tr><td colspan="2" class="tdfont">Subsistence/Laundry Allowance</td><td colspan="2" class="tdfont" style="text-align: right;">' . ($row2['Sublau_Status'] != 0 ? number_format(str_replace(' ', '', $sublau), 2) : "") . '</td></tr>';
                }
...
//------------------------------------- UNOFFICIAL PAYSLIP -------------------------------------//
    ...
    else
    {
        ...
        else if(isset($_REQUEST['Adate']))
        {
            ...
            $html .= '<p style="text-align: center; font-family: Arial; font-size: 13px; font-weight: bold; margin-top: -7px; margin-bottom: 4px;">Period Covered : ' . $year[0] . '</p>';
        }
        else if(isset($_REQUEST['Ydate']))
        {
             $html .= '<p style="text-align: center; font-family: Arial; font-size: 13px; font-weight: bold; margin-top: -7px; margin-bottom: 4px;">Period Covered : ' . $mon . ' ' . $row['year_covered'] . '</p>';
        ...
        else if(isset($_REQUEST['Rdate']))
        {
            ...
            $html .= '<p style="text-align: center; font-family: Arial; font-size: 13px; font-weight: bold; margin-top: -7px; margin-bottom: 4px;">Period Covered : ' . date('F',mktime(null,null,null,$month1,1)) . ' - ' . date('F',mktime(null,null,null,$month2,1)) . ' ' . $year . '</p>';
        }
    }
    ...
    if (isset($_REQUEST['cat']) && $_REQUEST['cat'] == 'Benefits') {
        ...
        {
            $html .= ($_REQUEST['cat'] == 'Summary' ? '<div style="margin-top: 40px; width: 50%; float: center; padding-left: 155px;">' : '<div style="margin: auto; width: 100%;">'); //$num != 0 &&  '<div class="leftcol2">'
            // $html .= '<div style="float: right;">';
            $html .= '<table>';
            $html .= '<tr>';
            $html .= '<th class="tdfont4" style="text-align: left;">Gross Basic Monthly Salary</th>';
            $html .= '<td class="tdfont4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . str_replace(' ', '', $row['Adj_basicmonsal']) . '&nbsp;&nbsp;&nbsp;</td>';
            $html .= '</tr>';
            $html .= '</table>';
            $html .= '<br>';

            $html .= '<table>';
            $html .= '<th><p style="font-family: Arial; font-size: 13.5px; font-weight: bold;">Less Deductions: </p></th>';
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['Salaries_withtax'] != "" && $row['Salaries_withtax'] != 0 ? '<tr><th class="tdfont4" style="text-align: left;">Salaries Withholding Tax</th><td class="tdfont5">...........' . number_format(str_replace(' ', '', (str_replace(',', '', $row['Salaries_withtax']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_rlip'] != "" && $row['GSIS_rlip'] != 0 ? '<tr><th class="tdfont5">GSIS - RLIP</th><td class="tdfont5">.................................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_rlip']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_ioliprem'] != "" && $row['GSIS_ioliprem'] != 0 ? '<tr><th class="tdfont5">GSIS - IOLI Premium</th><td class="tdfont5">................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_ioliprem']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_uoliloan'] != "" && $row['GSIS_uoliloan'] != 0 ? '<tr><th class="tdfont5">GSIS - UOLI Loan</th><td class="tdfont5">......................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_uoliloan']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_oli'] != "" && $row['GSIS_oli'] != 0 ? '<tr><th class="tdfont5">GSIS - OLI</th><td class="tdfont5">...................................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_oli']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_consoloan'] != "" && $row['GSIS_consoloan'] != 0 ? '<tr><th class="tdfont5">GSIS - Conso Loan</th><td class="tdfont5">......................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_consoloan']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_emergloan'] != "" && $row['GSIS_emergloan'] != 0 ? '<tr><th class="tdfont5">GSIS - Emergency Loan</th><td class="tdfont5">.............' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_emergloan']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_policyloanreg'] != "" && $row['GSIS_policyloanreg'] != 0 ? '<tr><th class="tdfont5">GSIS - Policy Loan Regular</th><td class="tdfont5">.......' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_policyloanreg']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_policyloanoptional'] != "" && $row['GSIS_policyloanoptional'] != 0 ? '<tr><th class="tdfont5">GSIS - Optional</th><td class="tdfont5">...........................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_policyloanoptional']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_educassistloan'] != "" && $row['GSIS_educassistloan'] != 0 ? '<tr><th class="tdfont5">GSIS - Education Assist. Loan</th><td class="tdfont5">...' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_educassistloan']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['GSIS_umidca'] != "" && $row['GSIS_umidca'] != 0 ? '<tr><th class="tdfont5">GSIS - UMID CA</th><td class="tdfont5">.........................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_umidca']))), 2) . '</td></tr>' : '');
            $html .= '</table>';
            //PAGIBIG
            $html .= '<table>';
            $html .= ($row['PAGIBIG_premium'] != "" && $row['PAGIBIG_premium'] != 0 ? '<tr><th class="tdfont5">PAGIBIG - Premium</th><td class="tdfont5">...................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PAGIBIG_premium']))), 2) . '</td></tr>' : '');
            $html .= '<table>';

            $html .= '<table>';
            $html .= ($row['PAGIBIG_MP2'] != "" && $row['PAGIBIG_MP2'] != 0 ? '<tr><th class="tdfont5">PAGIBIG - MP2</th><td class="tdfont5">...........................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PAGIBIG_MP2']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['PAGIBIG_MPL'] != "" && $row['PAGIBIG_MPL'] != 0 ? '<tr><th class="tdfont5">PAGIBIG - MPL</th><td class="tdfont5">..........................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PAGIBIG_MPL']))), 2) . '</td></tr>' : '');
            $html .= '<table>';

            $html .= '<table>';
            $html .= ($row['PAGIBIG_calamityloan'] != "" && $row['PAGIBIG_calamityloan'] != 0 ? '<tr><th class="tdfont5">PAGIBIG - Calamity Loan</th><td class="tdfont5">.........' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PAGIBIG_calamityloan']))), 2) . '</td></tr>' : '');
            $html .= '</table>';
            //PHILHEALTH
            $html .= '<table>';
            $html .= ($row['PHILH_cont'] != "" && $row['PHILH_cont'] != 0 ? '<tr><th class="tdfont5">Philhealth Contribution</th><td class="tdfont5">..............' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PHILH_cont']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['PHILH_arrears'] != "" && $row['PHILH_arrears'] != 0 ? '<tr><th class="tdfont5">Philhealth A/R(Arrears)</th><td class="tdfont5">..............' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PHILH_arrears']))), 2) . '</td></tr>' : '');
            $html .= '</table>';
            //PMPC
            $html .= '<table>';
            $html .= ($row['PMPC_capital'] != "" && $row['PMPC_capital'] != 0 ? '<tr><th class="tdfont5">PMPC - Capital</th><td class="tdfont5">............................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PMPC_capital']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['PMPC_loan'] != "" && $row['PMPC_loan'] != 0 ? '<tr><th class="tdfont5">PMPC - Loan</th><td class="tdfont5">................................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PMPC_loan']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['COPEA_dues'] != "" && $row['COPEA_dues'] != 0 ? '<tr><th class="tdfont5">COPEA Dues</th><td class="tdfont5">................................' . number_format(str_replace(' ', '', (str_replace(',', '', $row['COPEA_dues']))), 2) . '</td></tr>' : '');
            $html .= '</table>';
            //LBP
            $html .= '<table>';
            $html .= ($row['LBP_salaryloanreg'] != "" && $row['LBP_salaryloanreg'] != 0 ? '<tr><th class="tdfont5">LBP - Salary Loan Regular</th><td class="tdfont5">.........' . number_format(str_replace(' ', '', (str_replace(',', '', $row['LBP_salaryloanreg']))), 2) . '</td></tr>' : '');
            $html .= '</table>';

            $html .= '<table>';
            $html .= ($row['LBP_mobsalloanser'] != "" && $row['LBP_mobsalloanser'] != 0 ? '<tr><th class="tdfont5">LBP - Mobile Salary Loan</th><td class="tdfont5">..........' . number_format(str_replace(' ', '', (str_replace(',', '', $row['LBP_mobsalloanser']))), 2) . '</td><tr>' : '');
            $html .= '<table>';
            
            $html .= '<table>';
            $html .= ($row['Total_deduction'] != "" && $row['Total_deduction'] != 0 ? '<tr><th class="tdfont5">Total Deductions</th><td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['Total_deduction']))), 2) . '</td></tr>' : '');
             $html .= '</table>';
            // $html .= '</tr>';
            // $html .= ($row['Salaries_withtax'] != "" && $row['Salaries_withtax'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['Salaries_withtax']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_rlip'] != "" && $row['GSIS_rlip'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_rlip']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_ioliprem'] != "" && $row['GSIS_ioliprem'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_ioliprem']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_uoliloan'] != "" && $row['GSIS_uoliloan'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_uoliloan']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_oli'] != "" && $row['GSIS_oli'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_oli']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_consoloan'] != "" && $row['GSIS_consoloan'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_consoloan']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_emergloan'] != "" && $row['GSIS_emergloan'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_emergloan']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_policyloanreg'] != "" && $row['GSIS_policyloanreg'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_policyloanreg']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_policyloanoptional'] != "" && $row['GSIS_policyloanoptional'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_policyloanoptional']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_educassistloan'] != "" && $row['GSIS_educassistloan'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_educassistloan']))), 2) . '</td>' : '');
            // $html .= ($row['GSIS_umidca'] != "" && $row['GSIS_umidca'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_umidca']))), 2) . '</td>' : '');
            // $html .= ($row['PAGIBIG_premium'] != "" && $row['PAGIBIG_premium'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PAGIBIG_premium']))), 2) . '</td>' : '');
            // $html .= ($row['PAGIBIG_MP2'] != "" && $row['PAGIBIG_MP2'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PAGIBIG_MP2']))), 2) . '</td>' : '');
            // $html .= ($row['PAGIBIG_MPL'] != "" && $row['PAGIBIG_MPL'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PAGIBIG_MPL']))), 2) . '</td>' : '');
            // $html .= ($row['PAGIBIG_calamityloan'] != "" && $row['PAGIBIG_calamityloan'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PAGIBIG_calamityloan']))), 2) . '</td>' : '');
            // $html .= ($row['PHILH_cont'] != "" && $row['PHILH_cont'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PHILH_cont']))), 2) . '</td>' : '');
            // $html .= ($row['PHILH_arrears'] != "" && $row['PHILH_arrears'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PHILH_arrears']))), 2) . '</td>' : '');
            // $html .= ($row['PMPC_capital'] != "" && $row['PMPC_capital'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PMPC_capital']))), 2) . '</td>' : '');
            // $html .= ($row['PMPC_loan'] != "" && $row['PMPC_loan'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['PMPC_loan']))), 2) . '</td>' : '');
            // $html .= ($row['COPEA_dues'] != "" && $row['COPEA_dues'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['COPEA_dues']))), 2) . '</td>' : '');
            // $html .= ($row['LBP_salaryloanreg'] != "" && $row['LBP_salaryloanreg'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['LBP_salaryloanreg']))), 2) . '</td>' : '');
            // $html .= ($row['LBP_mobsalloanser'] != "" && $row['LBP_mobsalloanser'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['LBP_mobsalloanser']))), 2) . '</td>' : '');
            // $html .= ($row['Total_deduction'] != "" && $row['Total_deduction'] != 0 ? '<td class="tdfont5">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['Total_deduction']))), 2) . '</td>' : '');
            // $html .= '</tr>';
            $html .= '</table>';
            ...
            $html .= '<table>';
            $html .= '<tr>';
            $html .= '<td class="tdfont5"><b>Net Salaries</b></td><td class="tdfont" style="text-align: right;">' . number_format($naT, 2) . '</td>';
            $html .= '</tr>';
            $html .= '<table>';
            $html .= '</div>';
            $html .= '</div>';
            ...
            {
            $html .= '<div style="float: right; display: inline-block; margin-top: -253px;">';
                // $html .= ($_REQUEST['cat'] == 'Summary' ? '<div style="float:right; margin: auto;">' : '<div style="float:right; margin: auto;">');
                $html .= '<table style="align: center;">';
                $html .= '<tr>';
                $html .= '<td colspan="4" class="tdfont4" style="width: 100px; border-right: none; font-size: 13.5px;"><b>Other Benefits</b></td>';
                $html .= '</tr><tr>';
                $html .= '<td colspan="2" class="tdfont4">P.E.R.A:</td>';
                $html .= '<td class="tdfont4" style="text-align: right;">' . number_format(str_replace(' ', '', $pera), 2) . '</td><td class="tdfont4"></td>';
                $html .= '</tr><tr>';
                $html .= '<td colspan="2" class="tdfont4">Longevity Pay:</td>';
                $html .= '<td class="tdfont4" style="text-align: right;">' . ($row2['Longevity_Status'] != 0 ? number_format(str_replace(' ', '', $lon), 2) : "") . '</td><td class="tdfont4"></td>';
                $html .= '</tr><tr>';
                $html .= '<td colspan="2" class="tdfont4">Hazard Pay:</td>';
                $html .= '<td class="tdfont4" style="text-align: right;">' . ($row2['Hazard_Status'] != 0 ? number_format(str_replace(' ', '', $haz), 2) : "") . '</td><td class="tdfont4"></td>';
                $html .= '</tr><tr>';
                $html .= '<td colspan="2" class="tdfont4" style="border-right: none;">Subsistence/Laundry: </td>';
                $html .= '<td class="tdfont4" style="text-align: right;">' . ($row2['Sublau_Status'] != 0 ? number_format(str_replace(' ', '', $sublau), 2) : "") . '</td><td class="tdfont4" style="text-align: right;"></td>';
                $html .= '</tr><tr>';
                $html .= '<td colspan="2" class="tdfont4">Others</td>';
                $html .= '<td class="tdfont4"></td><td class="tdfont4"></td>';
                $html .= '</tr><tr>';
                $html .= '<td colspan="2" class="tdfont4" style="border-right: none;">Benefits Sub-Total: </td>';
                $html .= '<td class="tdfont4" style="text-align: right;"></td><td class="tdfont4" style="text-align: right;">' . number_format(str_replace(' ', '', $grTotal), 2) . '</td>';
                $html .= '</tr><tr>';
                $html .= '<td colspan="4" class="tdfont4" style="font-size: 13.5px;"><b>Less Deductions:</b></td>';
                $html .= '</tr><tr>';
    ...
    //            $html .= '</tr><tr>';
                $html .= '<td colspan="2" class="tdfont4">Withholding Tax & Others</td><td class="tdfont4"></td><td class="tdfont4"></td>';
                $html .= '</tr>';
                //----------------Longevity----------------//
                $lonsum = 0;
                for ($i = 0; $i < $londeduCount; $i++) {
    ...
    //            $html .= ($row2['Sublau_Status'] != 0 && $sublauplainOD != 0 ? (stripos(trim($sublauded1[1]), 'Tax') !== false || stripos(trim($sublauded1[1]), 'deduction') !== false ? "" : '<tr><td colspan="2" class="tdfontt">' . trim($sublauded1[1]) . ' (Subsistence & Laundry)</td><td class="tdfontt" style="text-align: right;">' . $sublauotherDeduc . '</td><td></td></tr>') : "");
                ...
                $html .= ($row2['Longevity_Status'] != 0 && $lonplainOD != 0 ? '<tr><td colspan="2" class="tdfont4">Longevity Deduction: </td><td class="tdfont4" style="text-align: right;">' . number_format($lonsumD, 2) . '</td><td class="tdfont4"></td></tr>' : "");
                $html .= ($row2['Hazard_Status'] != 0 && $hazplainOD != 0 ? '<tr><td colspan="2" class="tdfont4">Hazard Deduction: </td><td class="tdfont4" style="text-align: right;">' . number_format($hazsumD, 2) . '</td><td class="tdfont4"></td></tr>' : "");
                $html .= ($row2['Sublau_Status'] != 0 && $sublauplainOD != 0 ? '<tr><td colspan="2" class="tdfont4">Subsistence Laundry Deduction: </td><td class="tdfont4" style="text-align: right;">' . number_format($sublausumD, 2) . '</td><td class="tdfont4"></td></tr>' : "");
                 $html .= '<tr>';
                $html .= '<td colspan="2" class="tdfont4">Deductions Sub-Total: </td><td class="tdfont4" style="text-align: right;"></td><td class="tdfont4" style="text-align: right;">' . number_format($deductionTotal, 2) . '</td>';
                $html .= '</tr>';
                // $html .= '</table>';
                ...
                $html .= '<br>';
                // $html .= '<table>';
                $html .= '<td colspan="3" class="tdfont5" style="border-right: none;"><b>Net Other Benefits</b></td><td class="tdfont4" style="border-left: none; text-align: right; padding-right: 5px;">' . number_format(str_replace(' ', '', $nobOfficial), 2) . '</td>';
                $html .= '</tr>';
                $html .= '</table>';
    //            $html .= '</div>';
    //            $html .= '<div class="mrightcol">';
                ...
                $html .= '<table style="border: 2.5px solid #303030; margin-top: 10px; margin-bottom: 30px;">';
                $html .= '<tr>';
                $html .= '<td class="tdfont4" colspan="2" style="padding: 1.7px 0px 1.7px 10px;font-size: 13.5px;"><b>Summary (NET)</b></td>';
                $html .= '</tr><tr>';
                $html .= '<td class="tdfont4" style="padding: 1.7px 0px 1.7px 10px;">Salaries</td><td class="tdfont4" style="text-align: right; padding: 1.7px 0px 1.7px 10px;">' . number_format($naT, 2) . '&nbsp;</td>';
                $html .= '</tr><tr>';
                $html .= '<td class="tdfont4" style="padding: 1.7px 0px 1.7px 10px;">Other Benefits</td><td class="tdfont4" style="text-align: right; padding: 1.7px 0px 1.7px 10px;">' . number_format(str_replace(' ', '', $nobOfficial), 2) . '</td>';
                $html .= '</tr><tr>';
                $html .= '<td class="tdfont4" style="padding: 1.7px 0px 1.7px 10px; font-style: 10.5px;"><b>Net take home pay</b></td><td class="tdfont4" style="text-align: right; padding: 1.7px 0px 1.7px 10px; font-size: 13.5px;"><b>' . number_format($nthpOfficial, 2) . '&nbsp;</b></td>';
                $html .= '</tr>';
                $html .= '</table>';
