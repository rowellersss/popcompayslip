...
//
//    if ($_POST['day'] != '1-15') {
//        if (md5($_POST['ac']) == $_SESSION['INTRA_PASSWORD']) {
//            $empid = $_SESSION['INTRA_EMP_ID'];
//            $d1 = mysql_real_escape_string($_POST['month']);
//            $d2 = mysql_real_escape_string($_POST['day']);
//            $date = $d1 . " 1-15, 2017";
...
//            } elseif ($numcount != 0) {
//                $a = '_blank';
//                $_SESSION['INTRA_ACCESS'] = 'TRUE';
//                header("Location: ViewPayslip.php?date=" . $d1 . " 1-15, 2017");
//
//                /* echo "<script type=\"text/javascript\">
//                  window.open('ViewPayslip.php?date=" . $d1 . " 1-15, 2017', '_blank')
//                  </script>"; */
//            }
//        } else {
...
//            $a = '';
//            $empid = $_SESSION['INTRA_EMP_ID'];
//            $date = $_POST['month'] . ' ' . $_POST['day'] . ', 2017';
//            $sql = mysql_query("select * from table_payslip where Emp_no = '$empid' AND Adj_periodcovered = '$date'");
//            $numcount = mysql_num_rows($sql);
//            if ($numcount == 0) {
//                $a = '';
...
//            } elseif ($numcount != 0) {
//                $show = true;
//                $datefirst = $_POST['month'] . ' ' . $_POST['day'] . ', 2017';
//            }
//        } else {
//            $a = '';
//            $show = false;
...
<html lang="en-US">
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#cat').on('change', function () {
                    if ($('#cat').val() === 'Summary') {
                        $('#sap').show();
                        $('#his').hide();
                    } else if ($('#cat').val() === 'Payslip') {
                        $('#sap').show();
                        $('#his').hide();
                    } else if ($('#cat').val() === 'Benefits') {
                        $('#sap').show();
                        $('#his').hide();
                    } else if ($('#cat').val() === 'History') {
                        $('#sap').hide();
                        $('#his').show();
                    } else {
                        $('#sap,#his').hide();
            ...
            $(document).ready(function () {
                $('#year,#month').on('change', function () {
                    ...
                    $("#year4").val($("#year4 option:first").val());
                    $("#month4").val($("#month4 option:first").val());
                    $("#month41").val($("#month41 option:first").val());
                    $('#year2,#year3,#month3,#year4,#month4,#month41').selectpicker('refresh');
                });
                $('#year2').on('change', function () {
                    ...
                    $("#month4").val($("#month4 option:first").val());
                    $("#month41").val($("#month41 option:first").val());
                    $('#year,#month,#year3,#month3,#year4,#month4,#month41').selectpicker('refresh');
                });
                $('#year3,#month3').on('change', function () {
                    $("#year").val($("#year option:first").val());
                    $("#month").val($("#month option:first").val());
                    $("#year2").val($("#year2 option:first").val());
                    $("#year4").val($("#year4 option:first").val());
                    $("#month4").val($("#month4 option:first").val());
                    $("#month41").val($("#month41 option:first").val());
                    $('#year,#month,#year2,#year4,#month4,#month41').selectpicker('refresh');
                });
                $('#year4,#month4,#month41').on('change', function () {
                    $("#year").val($("#year option:first").val());
                    $("#month").val($("#month option:first").val());
                    $("#year2").val($("#year2 option:first").val());
                    $("#year3").val($("#year3 option:first").val());
                    $("#month3").val($("#month3 option:first").val());
                    $('#year,#month,#year2,#year3,#month3').selectpicker('refresh');
                });
            });
    ...
    <body class="theme-red zoom90" style="background-color: #e0e0e0;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" id="bodyy" class="body">
                                <div style="height: 730px; right: 0; width: auto; padding: 40px;">
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-7">
                                            <select name="cat" id="cat">
                                                ...
                                                <option value="Summary">Summary of Salary and Benefits</option>
                                                <option value="Payslip">Salary</option>
                                                <option value="Benefits">Other Benefits</option>
                                    ...
                                    <div id="sap">
                                        <form action="PayslipList.php?id=<?php echo $_GET['id']; ?>" method="post" id="paySlipForm">
                                            <input name="type" type="radio" id="monthly" value="Monthly" class="with-gap radio-col-orange" checked/>
                                            <label for="monthly"> Monthly &nbsp;&nbsp;&nbsp;</label>
                                            <input name="type" type="radio" id="annual" value="Annual" class="with-gap radio-col-orange" />
                                            <!-- <label for="annual"> Annual &nbsp;&nbsp;&nbsp;</label>
                                            <input name="type" type="radio" id="yearr" value="Year to Date" class="with-gap radio-col-orange" />
                                            <label for="yearr"> Year to Date &nbsp;&nbsp;&nbsp;</label>
                                            <input name="type" type="radio" id="range" value="Range to Date" class="with-gap radio-col-orange" />
                                            <label for="range"> Range of Date &nbsp;&nbsp;&nbsp;</label> -->
                                            ...
                                            <div class="row">
                                                ...
                                                <!--<select name="day" id="day" required>
                                                    ...
                                                    <div id="date3">
                                                        <h3>Choose Month</h3><br>
                                                        <select name="year3" id="year3" required>
                                                            <option value=""> Select Year</option>
                                                            <option value="2017">2017</option>
                                                            <option value="2018">2018</option>
                                                            <option value="2019">2019</option>
                                                        ...
                                                        <select name="month3" id="month3" required>
                                                            <option value="">Select Month</option>
                                                            <option value="01">January</option>
                                                            <option value="02">February</option>
                                                            <option value="03">March</option>
                                                    ...
                                                    <div id="date4">
                                                        <h3>Choose Month Range</h3><br>
                                                        <select name="year4" id="year4" required>
                                                            <option value=""> Select Year</option>
                                                            <option value="2017">2017</option>
                                                            <option value="2018">2018</option>
                                                            <option value="2019">2019</option>
                                                        ...
                                                        <select name="month4" id="month4" required>
                                                            <option value="">Select Month</option>
                                                            <option value="01">January</option>
                                                            <option value="02">February</option>
                                                            <option value="03">March</option>
                                                        ...
                                                        <select name="month41" id="month41" required>
                                                            <option value="">Select Month</option>
                                                            <option value="01">January</option>
                                                            <option value="02">February</option>
                                                            <option value="03">March</option>
                                                    ...
                                                    <input type="button" data-color="light-green" data-toggle="modal" data-target="#defaultModal" value="Submit" class="btn bg-light-green waves-effect">
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                                    <?php
                                                    if (isset($datefirst)) {
                                                        $empidd = $_SESSION['INTRA_EMP_ID'];
                                                        $sql1 = mysql_query("select * from table_payslip where Emp_no = '$empidd' AND Adj_periodcovered = '$datefirst'");
                                                        $sql2 = mysql_query("select * from table_empinfo where Employee_Id = '$empidd'");
                                                    ...
                                                    if (isset($show)) {
                                                        if ($show == true) {
                                                            ?>
                                                            <table style="border: 2.5px solid #303030;">
                                                                <tr>
                                                                    <td>Name</td><td style="background-color: white; color: black;"><?php echo ucwords(strtolower($row1['Name'])); ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Employee No.</td><td style="background-color: white; color: black;"><?php echo $row1['Emp_no']; ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Position</td><td style="background-color: white; color: black;"><?php echo $row1['Position']; ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Div/Unit</td><td style="background-color: white; color: black;"><?php echo $emp_div; ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Basic Monthly Salary</td><td style="background-color: white; color: black;"><?php echo str_replace(' ', '', $row1['Adj_basicmonsal']); ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="font-weight: 900;">Net Pay Jan 1-15</td><td style="background-color: white; font-weight: 900;"><?php echo str_replace(' ', '', $row1['Salaries_wagesreg']); ?></td>
                                                                </tr>
                                                            </table>
                                                            <?php
                                                        } else {
                                            ...
                                            <div class="modal fade payslipmodal" id="defaultModal" tabindex="-1" role="dialog">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="defaultModalLabel" align="center">Access Code</h4>
                                                        </div>
                                                        <div class="modal-body" align="center">
                                                            <br><br><input type="password" name="ac" id="acccode" style="padding: 7px; font-size: 16px; border-radius: 2px;"><br><br><br>
                                                        </div>
                                                        <div class="modal-footer" style="background-color: #eee">
                                                            <input type="hidden" name="continue">
                                                            <button type="button" name="test" id="modalCls" class="btn btn-link waves-effect">CONTINUE</button>
                                    ...
                                    <div id="his" style="width: 900px; margin: 0 auto;">
                                        <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Type</th>
                                                    <th>Amount</th>
                                                    <th>Month Applicable</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $empno = $_SESSION['INTRA_EMP_ID'];
                                                $query = mysql_query("SELECT * FROM table_payslip WHERE Emp_no = $empno ORDER BY year_covered and month_covered asc");
                                                while ($row = mysql_fetch_array($query)) {
                                                    $year = $row['year_covered'];
                                                    $month = $row['month_covered'];
                                                    $date_covered = $year.'-'.$month.'-01';
                                                    echo '<tr>';
                                                    echo '<td style="text-align: right;">' . date('M d, Y', strtotime($row['In_date'])) . '</td><td style="text-align: center;">Salary</td><td style="text-align: right;">' . $row['Net_amount'] . '</td><td style="text-align: center;">' . date('F Y', strtotime($date_covered)) . '</td>';
                                                    echo '</tr>';
                                                    echo '<tr>';
                                                    echo '<td style="text-align: right;">' . date('M d, Y', strtotime($row['In_date2'])) . '</td><td style="text-align: center;">Salary</td><td style="text-align: right;">' . $row['Net_amount2'] . '</td><td style="text-align: center;">' . date('F Y', strtotime($date_covered)) . '</td>';
                                                    echo '</tr>';
                                                }
                                                $query2 = mysql_query("SELECT * FROM table_otherbenefits WHERE Emp_no = $empno ORDER BY Longevity_date asc, Hazard_date asc, Sublau_date asc");
                                                while ($row2 = mysql_fetch_array($query2)) {
                                                    if (!empty($row2['Longevity_pay'])) {
                                                        echo '<tr>';
                                                        echo '<td style="text-align: right;">' . date('M d, 2017', strtotime($row2['Longevity_date'])) . '</td><td style="text-align: center;">Longevity Pay</td><td style="text-align: right;">' . number_format(str_replace(',', '', $row2['Longevity_pay']) - str_replace(',', '', $row2['Longevity_withtax']), 2) . '</td><td style="text-align: center;">' . date('F Y', strtotime($row2['Date_covered'])) . '</td>';
                                                        echo '</tr>';
                                                    }
                                                    if (!empty($row2['Hazard_pay'])) {
                                                        echo '<tr>';
                                                        echo '<td style="text-align: right;">' . date('M d, 2017', strtotime($row2['Hazard_date'])) . '</td><td style="text-align: center;">Hazard Pay</td><td style="text-align: right;">' . number_format(str_replace(',', '', $row2['Hazard_pay']) - str_replace(',', '', $row2['Hazard_withtax']), 2) . '</td><td style="text-align: center;">' . date('F Y', strtotime($row2['Date_covered'])) . '</td>';
                                                        echo '</tr>';
                                                    }
                                                    if (!empty($row2['Subsistence_allowance']) && !empty($row2['Laundry_allowance'])) {
                                                        echo '<tr>';
                                                        echo '<td style="text-align: right;">' . date('M d, 2017', strtotime($row2['Sublau_date'])) . '</td><td style="text-align: center;">Subsistence & Laundry Allowance</td><td style="text-align: right;">' . number_format(str_replace(',', '', ($row2['Subsistence_allowance']) + str_replace(',', '', $row2['Laundry_allowance'])) - $row2['Sublau_withtax'], 2) . '</td><td style="text-align: center;">' . date('F Y', strtotime($row2['Date_covered'])) . '</td>';
                                                        echo '</tr>';
                                                    }
                                                }
                                                ?>
                                    ...
                                    <?php
                                    $empid = $_SESSION['INTRA_EMP_ID'];
                                    $sql = mysql_query("Select * from table_payslip where Emp_no = '$empid'");
                                    while ($row = mysql_fetch_array($sql)) {
                                        //echo "<a style='text-decoration: underline;' href='ViewPayslip.php?date=" . $row['Adj_periodcovered'] . "' target='_blank'>Payslip for " . $row['Adj_periodcovered'] . "</a><br><br>";
                                    }
                                    ?>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            $(function () {
                $('.payslipmodal button[name=test]').on('click', function () {
                    var newTab = window.open('');
                    var numcount = 0;
                    var passw = '<?php echo $_SESSION['INTRA_PASSWORD']; ?>';
                    $.post('getPaySlipCount.php', $('#paySlipForm').serialize(), function (result) {
                        var json = $.parseJSON(result);
                        numcount = json.numcount;
                    }).done(function () {
                        if (numcount == 0) {
                            alert("No data found");
                            newTab.close();
                            ...
                            if ($('#year').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    newTab.close();
                                    alert("Incorrect access code!");
                                } else {
                                    //ViewPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    <?php if (isset($_REQUEST['print'])) {?>
                                    newTab.location = "MyPayslip.php?cat=" + $('#cat').val() + "&Mdate=" + $('#year').val() + "-" + $('#month').val() + "-01&print=all";
                                    <?php } elseif (!isset($_REQUEST['print'])) {?>
                                    newTab.location = "MyPayslip.php?cat=" + $('#cat').val() + "&Mdate=" + $('#year').val() + "-" + $('#month').val() + "-01";
                                    <?php } ?>
                                }
                            } else if ($('#year2').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    ...
                                    //MyPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    <?php if (isset($_REQUEST['print'])) {?>
                                    newTab.location = "MyPayslip.php?cat=" + $('#cat').val() + "&Adate=" + $('#year2').val() + "-01-01&Adate2=" + $('#year2').val() + "-12-01&print=all";
                                    <?php } elseif (!isset($_REQUEST['print'])) {?>
                                    newTab.location = "MyPayslip.php?cat=" + $('#cat').val() + "&Adate=" + $('#year2').val() + "-01-01&Adate2=" + $('#year2').val() + "-12-01";
                                    <?php } ?>
                                }
                            } else if ($('#year3').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    ...
                                    //MyPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    <?php if (isset($_REQUEST['print'])) {?>
                                    newTab.location = "MyPayslip.php?cat=" + $('#cat').val() + "&Ydate=" + $('#year3').val() + "-01-01&Ydate2=" + $('#year3').val() + '-' + $('#month3').val() + "-01&print=all";
                                    <?php } elseif (!isset($_REQUEST['print'])) {?>
                                        newTab.location = "MyPayslip.php?cat=" + $('#cat').val() + "&Ydate=" + $('#year3').val() + "-01-01&Ydate2=" + $('#year3').val() + '-' + $('#month3').val() + "-01";
                                    <?php } ?>
                                }
                            } else if ($('#year4').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    ...
                                    //MyPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    <?php if (isset($_REQUEST['print'])) {?>
                                    newTab.location = "MyPayslip.php?cat=" + $('#cat').val() + "&Rdate=" + $('#year4').val() + '-' + $('#month4').val() + '-01&Rdate2=' + $('#year4').val() + '-' + $('#month41').val() + '-01&print=all';
                                    <?php } elseif (!isset($_REQUEST['print'])) {?>
                                    newTab.location = "MyPayslip.php?cat=" + $('#cat').val() + "&Rdate=" + $('#year4').val() + '-' + $('#month4').val() + '-01&Rdate2=' + $('#year4').val() + '-' + $('#month41').val() + '-01';
                                    <?php } ?>
                                }
                            }
                            ...
                            //                                    alert("Incorrect access code!");
                            //                                } else {
                            //                                    $('input[name=continue]').val("continue");
                            //                                    $('#paySlipForm').submit();
                            //                                }
                            //                            } else if (day === '16-31') {
                            //
                            ...
                            //                                } else {
                            //
                            //                                    newTab.location = "ViewPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017";
                            //                                }
                            //                            }
