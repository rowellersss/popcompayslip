...
if (isset($_POST['update'])) {
    ...
    $abms = mysql_real_escape_string($_POST['abms']);
//    $apc1 = mysql_real_escape_string($_POST['apc1']);
//    $apc2 = mysql_real_escape_string($_POST['apc2']);
    $swr1 = mysql_real_escape_string($_POST['swr1']);
    $swr2 = mysql_real_escape_string($_POST['swr2']);
    $swtx = mysql_real_escape_string($_POST['swtx']);
    $gsrl = mysql_real_escape_string($_POST['gsrl']);
    $gsio = mysql_real_escape_string($_POST['gsio']);
    $gsuo = mysql_real_escape_string($_POST['gsuo']);
    $gsol = mysql_real_escape_string($_POST['gsol']);
    $gscl = mysql_real_escape_string($_POST['gscl']);
    $gsel = mysql_real_escape_string($_POST['gsel']);
    $gspl = mysql_real_escape_string($_POST['gspl']);
    $gsop = mysql_real_escape_string($_POST['gsop']);
    $gsea = mysql_real_escape_string($_POST['gsea']);
    $gsuc = mysql_real_escape_string($_POST['gsuc']);
    $papr = mysql_real_escape_string($_POST['papr']);
    $pam2 = mysql_real_escape_string($_POST['pam2']);
    $paml = mysql_real_escape_string($_POST['paml']);
    $pacl = mysql_real_escape_string($_POST['pacl']);
    $phco = mysql_real_escape_string($_POST['phco']);
    $phar = mysql_real_escape_string($_POST['phar']);
    $pmca = mysql_real_escape_string($_POST['pmca']);
    $pmlo = mysql_real_escape_string($_POST['pmlo']);
    $codu = mysql_real_escape_string($_POST['codu']);
    $lbsl = mysql_real_escape_string($_POST['lbsl']);
    $lbms = mysql_real_escape_string($_POST['lbms']);
    $tode = mysql_real_escape_string($_POST['tode']);
    $nea1 = mysql_real_escape_string($_POST['nea1']);
    $nea2 = mysql_real_escape_string($_POST['nea2']);

    mysql_query("UPDATE table_payslip SET"
                    . "     Adj_basicmonsal = '$abms', Salaries_wagesreg = '$swr1', Salaries_wagesreg = '$swr2',"
                    . "     Salaries_withtax = '$swtx', GSIS_rlip = '$gsrl', GSIS_ioliprem = '$gsio', GSIS_uoliloan = '$gsuo', GSIS_oli = '$gsol', GSIS_consoloan = '$gscl',"
                    . "     GSIS_emergloan = '$gsel', GSIS_policyloanreg = '$gspl', GSIS_policyloanoptional = '$gsop', GSIS_educassistloan = '$gsea', GSIS_umidca = '$gsuc',"
                    . "     PAGIBIG_premium = '$papr', PAGIBIG_MP2 = '$pam2', PAGIBIG_MPL = '$paml', PAGIBIG_calamityloan = '$pacl', PHILH_cont = '$phco', PHILH_arrears = '$phar',"
                    . "     PMPC_capital = '$pmca', PMPC_loan = '$pmlo', COPEA_dues = '$codu', LBP_salaryloanreg = '$lbsl', LBP_mobsalloanser = '$lbms', Total_deduction = '$tode',"
                    . "     Net_amount = '$nea1', Net_amount2 = '$nea2' WHERE Emp_no = '$emp' AND Adj_periodcovered = '$date'") or die(mysql_error());

    $_SESSION['INTRA_INDICATOR'] = 'true';
}
?>
...
<html lang="en-US">
    ...
    <head>
        ...
        <style>
            ...
            table.dataTable tbody td:nth-child(1), td:nth-child(2){
                background-color: #EFEFEF;
            }
            .DTFC_LeftBodyLiner {
                overflow-x: hidden;
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    UPDATE SALARY
                                    <small>VERIFY SALARY</small>
                                </h2>
                                <div class="pull-right">

                                </div>
                            </div>
                            <div style="background-color: #fff; min-height: 80vh;" class="body">

                                <form action="EditPayroll.php?emp=<?php echo $_GET['emp'] . '&date=' . $_GET['date']; ?>" method="post">
                                    <table id="example" class="table-bordered stripe row-border order-column" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" class="fixed-side">Serial No.</th>
                                                <th rowspan="2" class="fixed-side">Name</th>
                                                <th rowspan="2">Position</th>
                                                <th rowspan="2">Employee No.</th>
                                                <th rowspan="2">Adjusted<br>Basic Monthly<br>Salary</th>
                                                <th rowspan="2" style="padding-left: 30px; padding-right: 30px;">In Date</th>
                                                <th rowspan="2">Adjusted<br>Period Covered</th>
                                                <th rowspan="2">Salaries and <br> Wages-Regular</th>
                                                <th rowspan="2">Salaries<br>Withholding Tax</th>
                                                <th colspan="10">GSIS</th>
                                                <th colspan="4">PAGIBIG</th>
                                                <th colspan="2">PHILHEALTH</th>
                                                <th colspan="2">PMPC</th>
                                                <th rowspan="2">COPEA Dues</th>
                                                <th colspan="2">LBP</th>
                                                <th rowspan="2">Total <br> Deduction</th>
                                                <th colspan="2">Net Amount Due</th>
                                            </tr>
                                            <tr>
                                                <!--GSIS-->
                                                <th>RLIP</th>
                                                ...
                                                <th>Policy Loan <br> Regular</th>
                                                <th>Optional</th>
                                                <th>Education <br >Assist. Loan</th>
                                                <th>UMID CA</th>
                                                <!--PAGIBIG-->
                                                <th>Premium</th>
                                                <th>MP2</th>
                                                ...
                                                <!--PHILHEALTH-->
                                                <th>Cont.</th>
                                                <th>A/R(Arrears) <br> (Nov./Dec.2016)</th>
                                                <!--PMPC-->
                                                <th>Capital</th>
                                                <th>Loan</th>
                                                <!--LBP-->
                                                <th>Salary Loan <br> Regular</th>
                                                <th>Mobile Salary <br> Loan Saver</th>
                                                <!--Net Amount-->
                                                <th>1-15</th>
                                                <th>16-31</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            $datee = $_REQUEST['date'];
                                            $emp = $_REQUEST['emp'];
                                            $query = mysql_query("SELECT * FROM table_payslip WHERE Emp_no = '$emp' AND Adj_periodcovered = '$datee'");
                                            //            $query = mysql_query("SELECT A.*, B.* FROM table_payslip A"
                                            ...
                                            while ($row = mysql_fetch_array($query)) {
                                                ...
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="abms" class="form-control" value="' . ($row['Adj_basicmonsal'] != '' ? str_replace(',', '', $row['Adj_basicmonsal']) : 0) . '"></div></td>';
                                                echo '<td>' . $row['In_date'] . '</td>';
                                                echo '<td>' . $row['Adj_periodcovered'] . '</td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="swr1" class="form-control" value="' . ($row['Salaries_wagesreg'] != '' ? str_replace(',', '', $row['Salaries_wagesreg']) : 0) . '"></div></td>';
                                                echo '<td></td>';
                                                echo '<td></td>';
                                                echo '<td></td>';
                                                echo '<td></td>';
                                                ...
                                                echo '<td></td>';
                                                echo '<td></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="nea1" class="form-control" value="' . ($row['Net_amount'] != '' ? str_replace(',', '', $row['Net_amount']) : 0) . '"></div></td>';
                                                echo '<td></td>';
                                                echo '</tr>';
                                                ...
                                                echo '<td></td>';
                                                echo '<td></td>';
                                                echo '<td>' . $row['In_date2'] . '</td>';
                                                echo '<td>' . $row['Adj_periodcovered2'] . '</td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="swr2" class="form-control" value="' . ($row['Salaries_wagesreg2'] != '' ? str_replace(',', '', $row['Salaries_wagesreg2']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="swtx" class="form-control" value="' . ($row['Salaries_withtax'] != '' ? str_replace(',', '', $row['Salaries_withtax']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gsrl" class="form-control" value="' . ($row['GSIS_rlip'] != '' ? str_replace(',', '', $row['GSIS_rlip']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gsio" class="form-control" value="' . ($row['GSIS_ioliprem'] != '' ? str_replace(',', '', $row['GSIS_ioliprem']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gsuo" class="form-control" value="' . ($row['GSIS_uoliloan'] != '' ? str_replace(',', '', $row['GSIS_uoliloan']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gsol" class="form-control" value="' . ($row['GSIS_oli'] != '' ? str_replace(',', '', $row['GSIS_oli']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gscl" class="form-control" value="' . ($row['GSIS_consoloan'] != '' ? str_replace(',', '', $row['GSIS_consoloan']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gsel" class="form-control" value="' . ($row['GSIS_emergloan'] != '' ? str_replace(',', '', $row['GSIS_emergloan']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gspl" class="form-control" value="' . ($row['GSIS_policyloanreg'] != '' ? str_replace(',', '', $row['GSIS_policyloanreg']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gsop" class="form-control" value="' . ($row['GSIS_policyloanoptional'] != '' ? str_replace(',', '', $row['GSIS_policyloanoptional']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gsea" class="form-control" value="' . ($row['GSIS_educassistloan'] != '' ? str_replace(',', '', $row['GSIS_educassistloan']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="gsuc" class="form-control" value="' . ($row['GSIS_umidca'] != '' ? str_replace(',', '', $row['GSIS_umidca']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="papr" class="form-control" value="' . ($row['PAGIBIG_premium'] != '' ? str_replace(',', '', $row['PAGIBIG_premium']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="pam2" class="form-control" value="' . ($row['PAGIBIG_MP2'] != '' ? str_replace(',', '', $row['PAGIBIG_MP2']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="paml" class="form-control" value="' . ($row['PAGIBIG_MPL'] != '' ? str_replace(',', '', $row['PAGIBIG_MPL']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="pacl" class="form-control" value="' . ($row['PAGIBIG_calamityloan'] != '' ? str_replace(',', '', $row['PAGIBIG_calamityloan']) : '') . '"></div></td>';                                                            
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="phco" class="form-control" value="' . ($row['PHILH_cont'] != '' ? str_replace(',', '', $row['PHILH_cont']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="phar" class="form-control" value="' . ($row['PHILH_arrears'] != '' ? str_replace(',', '', $row['PHILH_arrears']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="pmca" class="form-control" value="' . ($row['PMPC_capital'] != '' ? str_replace(',', '', $row['PMPC_capital']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="pmlo" class="form-control" value="' . ($row['PMPC_loan'] != '' ? str_replace(',', '', $row['PMPC_loan']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="codu" class="form-control" value="' . ($row['COPEA_dues'] != '' ? str_replace(',', '', $row['COPEA_dues']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="lbsl" class="form-control" value="' . ($row['LBP_salaryloanreg'] != '' ? str_replace(',', '', $row['LBP_salaryloanreg']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="lbms" class="form-control" value="' . ($row['LBP_mobsalloanser'] != '' ? str_replace(',', '', $row['LBP_mobsalloanser']) : '') . '"></div></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="tode" class="form-control" value="' . ($row['Total_deduction'] != '' ? str_replace(',', '', $row['Total_deduction']) : '') . '"></div></td>';
                                                echo '<td></td>';
                                                echo '<td><div style="margin-bottom: -5px; font-size: 10px;"><input class="font" type="text" name="nea2" class="form-control" value="' . ($row['Net_amount2'] != '' ? str_replace(',', '', $row['Net_amount2']) : '') . '"></div></td>';
                                                echo '</tr>';
                                            }
                                            ?>
                                        </tbody>
                                    ...
                                    <br><br>
                                    <input type="submit" name="update" class="btn bg-teal btn-md waves-effect" value="Update">
                                </form>

                            </div>
                            <!--<a type="hidden" href="../files">Back</a>-->
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php
    if (isset($_SESSION['INTRA_INDICATOR']) && $_SESSION['INTRA_INDICATOR'] == 'true') {
        ?>
        <script>
            $(document).ready(function () {
                swal("Successful!", "Payroll has successfully updated!", "success");
            })
        </script>
        <?php
    }
    ...
    <script language="javascript">
                ...
                $.post('ajaxData.php',
                        ...
                        function (data) {
                            ...
                            if (json.error === 0) {
                                ...
                                $('#mess2').html(json.message)
                                $('#mess2').removeClass('hidden')
                            }
                        });
            });
            //ViewPayroll.php?emp=' . $row['Emp_no'] . '&date=' . $row['Adj_periodcovered'] . '&act=app" data-emp="' . $row['Emp_no'] . '
            $('#example').on('click', 'a.confirmme', function (e) {
                e.preventDefault();
                var a = $(this);
                ...
                function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ViewPayroll.php?emp=' + emp + '&date=' + date + '&act=app',
                        success: function () {
                            $('#example').attr("id");
                            a.closest('td').html('<i class="material-icons" style="color: green;">done</i>');
                            swal("Successful!", "The data is now verified.", "success");
                        }
                    });
                });
        ...
        function deacme(id)
        {
            if (confirm("Are you sure you want to deactivate this account?")) {
                window.location.href = 'ManageAccounts.php?id=' + id + '&act=disapp';
                return true;
            }
        }
        ...
        function actme(id)
        {
            if (confirm("Are you sure you want to activate this account?")) {
                window.location.href = 'ManageAccounts.php?id=' + id + '&act=app';
                return true;
            }
        }
        ...
        function delme(id)
        {
            if (confirm("Are you sure you want to delete this account?")) {
                window.location.href = 'ManageAccounts.php?id=' + id + '&act=del';
                return true;
            }
        }
    </script>
...
<?php
unset($_SESSION['INTRA_INDICATOR']);
// free memory
unset($lang);
unset($icon);
unset($_extensions);
