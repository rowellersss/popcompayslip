...
function css() {
    ...
    if (file_exists('../cs/jquery.twbsPagination.min.js'))
...
//$parentdirad = basename(dirname($_SERVER['PHP_SELF']));
...
if (isset($_GET['table']) && AJAX_request()) {
    ...
    if ($directory != ".") {
        $html .= '<a href = "#" class = "btn bg-green waves-effect" style = "text-decoration: none;" onclick = "SetNewFolderModalattr(); return false;"><i class = "material-icons">folder</i>' . $lang[29] . '</a>&nbsp;&nbsp;&nbsp';
        $html .= '<a href="#" class="btn bg-light-green waves-effect" style="text-decoration: none;" onclick="SetUploadFileModalattr(); return false;"><i class="material-icons">file_upload</i>' . $lang[30] . '</a><br><br>';
    }
    ...
    if (is_array($files) || is_object($files))
        foreach ($files as $index => $file) {
            if (extension($file) != "php" && extension($file) != "css" && extension($file) != "js") {
                ...
                $html.='<td class="hidden-xs col-xs-3 col-sm-3 col-md-3">';
                //if ( == 0) {
                $html.= action($file);
                //}
                $html.= '</td></tr>';
...
//}
    ...
    <body class="theme-red zoom90" style="background-color: #e0e0e0;"><!-- zoom90-->
        <!-- Page Loader -->
        ...
        <!-- #END# Search Bar -->
        <!-- Top Bar -->
        <nav class="navbar" style="background-color: #0d501b;"><!--043d10-->
                ...
                <div class="row clearfix">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div style="background-color: #fff; min-height: 80vh;" id="bodyy" class="body">
                                <div style="min-height: 77vh; right: 0; width: auto; background-color: #fff; border-radius: 5px; padding: 40px;">
                                    <div id="mess">
                                    </div>
                                    <div>
                                        <div class = "navbar-form navbar-<?php text_position(); ?>"  role="search">
                                            <div class="input-group">
                                                <div class="form-line"><input type="text" style="background-color: #fff" class="form-control" id="inputSearch" placeholder="<?php echo $lang[19]; ?>" name="q"></div>
