...
$empid2 = $_SESSION['INTRA_EMP_ID'];
$sql2 = mysql_query("select * from table_empinfo where Employee_Id = '$empid2'");
$row2 = mysql_fetch_assoc($sql2);
$pos = $row2['Position'];
$sql4 = mysql_query("Select * from table_posaccesslvl where position = '$pos' AND accesslvl_id = 3");
$numrow = mysql_num_rows($sql4);
if ($numrow <= 0) {
    header("Location: index.php");
}
...
if (isset($_POST['submit'])) {
    if (md5($_POST['ac']) == $_SESSION['INTRA_PASSWORD']) {
        ...
        $d3 = mysql_real_escape_string($_POST['empid']);
        $date = $d1 . " 2017";
        $sql = mysql_query("select * from table_payslip where Emp_no = '$d3' AND Adj_periodcovered = '$date'");
        ...
        if ($numcount == 0) {
            ...
            $a = '_blank';
            $_SESSION['INTRA_ACCESS2'] = 'TRUE';
            header("Location: ViewPayslip.php?date=" . $d1 . " 2017&empid=" . md5($d3));
        }
    } else {
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" class="body">
                                <div style="height: 950px; right: 0; width: auto; padding: 0px 40px 40px 40px;"><br><br>
                                    
                                    <form action="ViewEmployeePayslip.php" method="post" target="<?php echo $a; ?>" >
                                        ...
                                        <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                            ...
                                            <tbody >
                                                <?php
                                                $sql = mysql_query("Select table_empinfo.*, table_position.* from table_empinfo"
                                                        . "           join table_position "
                                                        . "                 on table_position.position_id = table_empinfo.Position where Employee_Id != ''");
                                                while ($row1 = mysql_fetch_array($sql)) {
                                                    if ($row1['division_id'] == 1) {
                                                        $div = 'Office of the Executive Director';
                                                    }if ($row1['division_id'] == 2) {
                                                        $div = 'Internal Audit Unit';
                                                    }if ($row1['division_id'] == 3) {
                                                        $div = 'Administrative Division';
                                                    }if ($row1['division_id'] == 4) {
                                                        $div = 'Financial & Management Division';
                                                    }if ($row1['division_id'] == 5) {
                                                        $div = 'Planning, Monitoring & Evaluation Division';
                                                    }if ($row1['division_id'] == 6) {
                                                        $div = 'Policy Analysis & Dev\'t. Division';
                                                    }if ($row1['division_id'] == 7) {
                                                        $div = 'Information Mgt. & Communications Division';
                                                    }if ($row1['division_id'] == 8) {
                                                        $div = 'NCR';
                                                    }if ($row1['division_id'] == 9) {
                                                        $div = 'RPO 1';
                                                    }if ($row1['division_id'] == 10) {
                                                        $div = 'RPO 2';
                                                    }if ($row1['division_id'] == 11) {
                                                        $div = 'RPO 3';
                                                    }if ($row1['division_id'] == 12) {
                                                        $div = 'RPO 4';
                                                    }if ($row1['division_id'] == 13) {
                                                        $div = 'RPO 5';
                                                    }if ($row1['division_id'] == 14) {
                                                        $div = 'RPO 6';
                                                    }if ($row1['division_id'] == 15) {
                                                        $div = 'RPO 7';
                                                    }if ($row1['division_id'] == 16) {
                                                        $div = 'RPO 8';
                                                    }if ($row1['division_id'] == 17) {
                                                        $div = 'RPO 9';
                                                    }if ($row1['division_id'] == 18) {
                                                        $div = 'RPO 10';
                                                    }if ($row1['division_id'] == 19) {
                                                        $div = 'RPO 11';
                                                    }if ($row1['division_id'] == 20) {
                                                        $div = 'RPO 12';
                                                    }if ($row1['division_id'] == 21) {
                                                        $div = 'CAR';
                                                    }if ($row1['division_id'] == 22) {
                                                        $div = 'CARAGA';
                                                    }

                                                    $string = trim($row1['Middlename']);
                                                    if ($string == '' || ctype_space($string)) {
                                                        $name = ucwords(strtolower($row1['Lastname'])) . ', ' . ucwords(strtolower($row1['Firstname']));
                                                        ...
                                                        $name = ucwords(strtolower($row1['Lastname'])) . ', ' . ucwords(strtolower($row1['Firstname'])) . ' ' . strtoupper($acronym) . '.';
                                                    }
                                                     // echo '<tr><td>' . $name . '</td><td>' . $div . '</td><td><a href="EmpPayslipList.php?id=' . $row1['Employee_Id'] . '" class="btn bg-light-green btn-xs waves-effect" target="_blank">View</a></td></tr>';
                                                    
                                                    $sql2 = mysql_query("SELECT verified FROM table_payslip WHERE Emp_no = ".$row1['Employee_Id']."");
                                                    $result = mysql_fetch_assoc($sql2);
                                                    {
                                                        if($result['verified'] == 'Yes')
                                                        {
                                                            echo '<tr><td>' . $name . '</td><td>' . $div . '</td><td><a href="EmpPayslipList.php?id=' . $row1['Employee_Id'] . '" class="btn bg-light-green btn-xs waves-effect" target="_blank">View</a>&nbsp';
                                                            echo '<a class="btn bg-pink btn-xs waves-effect" target="_blank">Approved</a></td></tr>';
                                                        }
                                                        else
                                                        {
                                                             echo '<tr><td>' . $name . '</td><td>' . $div . '</td><td><a href="EmpPayslipList.php?id=' . $row1['Employee_Id'] . '" class="btn bg-light-green btn-xs waves-effect" target="_blank">View</a></td></tr>';
                                                    ...
                                                    //echo '<tr><td>' . $row1['Id'] . '</td><td>' . $row1['Firstname'] . ' ' . $row1['Lastname'] . '</td><td>' . $div . '</td><td><input type="button" data-color="light-green" data-toggle="modal" data-id="' . $row1['Employee_Id'] . '" data-target="#defaultModal" value="View Payslip" class="btn bg-light-green btn-xs waves-effect"></td></tr>';
                                                }
                                                ?>
                                            </tbody>
                                        </table>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" align="center">
                                                        <br><br><input type="password" name="ac" style="padding: 7px; font-size: 16px; border-radius: 2px;"><br><br><br>
                                                    </div>
                                                    <div class="modal-footer" style="background-color: #eee">
                                                        <input type="submit" name="submit" value="CONTINUE" class="btn btn-link waves-effect">
