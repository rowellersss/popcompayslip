...
//---------------------- FIRST COPY --------------------------//
    ...
    if (isset($_REQUEST['cat']) && $_REQUEST['cat'] == 'Benefits') {
        ...
        $html .= '<tr>';
        $html .= '<td class="tdfont">Compensations Salary</td>';
        $html .= '</tr>';
        
        if(isset($_REQUEST['Mdate']))
        {
            $html .= '<tr>';
            $html .= '<td class="tdfont">&nbsp;&nbsp;&nbsp;&nbsp;Salary 1st cut off</td>';
            $html .= '<td class="tdfont" style="text-align: right;">' . str_replace(' ', '', $row['Adj_periodcovered']) . '</td>';
            $html .= '</tr>';
            $html .= '<tr>';
            $html .= '<td class="tdfont">&nbsp;&nbsp;&nbsp;&nbsp;Salary 2nd cut off</td>';
            $html .= '<td class="tdfont" style="text-align: right;">' . str_replace(' ', '', $row['Adj_periodcovered2']) . '</td>';
            $html .= '<tr>';
        }
        ...
        if ($row['Pera1'] != "" && $row['Pera1'] != 0.00 && $row['Pera2'] != "" && $row['Pera2'] != 0.00) {
            $html .= '<tr><td class="tdfont">P.E.R.A</td><td class="tdfont" style="text-align: right;">' . number_format(str_replace(' ', '', (str_replace(',', '', $peraSP))), 2) . '</td></tr>';
        }
        if ($row['Lwop'] != "" && $row['Lwop'] != 0.00) {
            $html .= '<tr><td class="tdfont">LWOP</td><td class="tdfont" style="text-align: right;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['Lwop']))), 2) . '</td></tr>';
        }
        ...
        if ($row['GSIS_calamityloan'] != "" && $row['GSIS_calamityloan'] != 0) {
            $html .= '<tr><td class="tdfont">GSIS - Calamity Loan</td><td class="tdfont" style="text-align: right;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_calamityloan']))), 2) . '</td></tr>';
        }
        ...
        if ($row['A/R_pldt'] != "" && $row['A/R_pldt'] != 0) {
            $html .= '<tr><td class="tdfont">A/R PLDT</td><td class="tdfont" style="text-align: right;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['A/R_pldt']))), 2) . '</td></tr>';
        }
        ...
        if ($row['COPEA_loan'] != "" && $row['COPEA_loan'] != 0) {
            $html .= '<tr><td class="tdfont">COPEA Loan</td><td class="tdfont" style="text-align: right;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['COPEA_loan']))), 2) . '</td></tr>';
        }
        ...
        {
            $html .= '<tr>';
            $html .= '<td class="tdfont">1st cut-off Deduction</td>';
            $html .= '<td class="tdfont" style="text-align: right;">' . str_replace(' ', '', $row['Total_deduction']) . '</td>';
            $html .= '</tr>';
            $html .= '<tr>';
            $html .= '<td class="tdfont">2nd cut-off Deduction</td>';
            $html .= '<td class="tdfont" style="text-align: right;">' . str_replace(' ', '', $row['Total_deduction2']) . '</td>';
            $html .= '<tr>';
        }
...
//$html .= '<tr><td style="border-top: 2px solid black;"><b>Net Amount Due</b></td><td style="border-top: 2px solid black;"><b>' . number_format(str_replace(' ', '', $row['Net_amount']), 2) . '</b></td></tr>';
        ...
        if(isset($_REQUEST['Adate'])){
            ...
            $html .= '<td class="tdfont">&nbsp;&nbsp;&nbsp;&nbsp;' . $mc1[0] . ' ' . $mc1[1] . '</td>';
            $html .= '<td class="tdfont" style="text-align: right;">' . str_replace(' ', '', $row['Net_amount']) . '</td>';
            $html .= '</tr>';
            $html .= '<tr>';
            $html .= '<td class="tdfont">&nbsp;&nbsp;&nbsp;&nbsp;' . $mc2[0] . ' ' . $mc2[1] . '</td>';
            $html .= '<td class="tdfont" style="text-align: right;">' . str_replace(' ', '', $row['Net_amount2']) . '</td>';
        }
        $html .= '</tr>';
        $html .= '<tr>';
