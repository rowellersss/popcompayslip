...
if (isset($_POST['update'])) {
    ...
    $cpassword = $npassword = $opassword = '';
    $cpasswordErr = $npasswordErr = $opasswordErr = '';
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["npass"])) {
            $npasswordErr = "This field is required!";
        } elseif (!empty($_POST["npass"]) && ($_POST["npass"] == $_POST["cpass"])) {
            $npassword = $_POST["npass"];
            $cpassword = $_POST["cpass"];
            $sql1 = "SELECT Password FROM table_empacc where Password = '$md5'";
            $res1 = mysql_query($sql1) or die("Wrong table Structure!" . mysql_error());
            // if(mysql_num_rows($res1) > 0){
            //     $npasswordErr = "This password is already existing";
            // }
        ...
        if (empty($_POST["opass"])) {
            $opasswordErr = "This field is required!";
        } else {
            $npassword = $_POST["opass"];
            $sql2 = "SELECT Password FROM table_empacc where Password = '$md52'";
            $res2 = mysql_query($sql2) or die("Wrong table Structure!" . mysql_error());
            if (mysql_num_rows($res2) == 0) {
                $opasswordErr = "No such Password";
            }
        }
    }
    if (empty($opasswordErr) && empty($npasswordErr) && empty($cpasswordErr)) {
        $id4 = $_SESSION['INTRA_EMP_ID'];
        mysql_query("Update table_empacc set Password = '$md5' where Emp_Id = '$id4'");
                                        ...
                                        <div class="col-sm-4">
                                            <form action="newPass.php" method="post">
                                                <div class="row clearfix">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                if (isset($opasswordErr)) {
                                                                    echo '<b style="color: tomato;" class = "bold">' . $opasswordErr . '</b>';
                                                                }
                                                                ?>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                if (isset($npasswordErr)) {
                                                                    echo '<b style="color: tomato;" class = "bold">' . $npasswordErr . '</b>';
                                                                }
                                                                ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                if (isset($cpasswordErr)) {
                                                                    echo '<b style="color: tomato;" class = "bold">' . $cpasswordErr . '</b>';
                                                                }
                                                                ?>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <p style="color: tomato; font-weight: bold; font-style: italic;">Note: Your password must contain a minimum of 8 characters.</p>
                                                        </div>
                                                    </div>

                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <input type="submit" name="update" class="btn bg-cyan waves-effect">
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
