...
if (isset($_REQUEST['emp']) && $_REQUEST['act'] == 'app') {
    ...
    mysql_query("UPDATE table_otherbenefits SET Longevity_Status = 2 WHERE Emp_no = '$emp' AND Longevity_date = '$date'");
} elseif (isset($_REQUEST['emp']) && $_REQUEST['act'] == 'app1') {
    $emp = $_REQUEST['emp'];
    $date = $_REQUEST['date'];

    mysql_query("UPDATE table_otherbenefits SET Hazard_Status = 2 WHERE Emp_no = '$emp' AND Hazard_date = '$date'");
} elseif (isset($_REQUEST['emp']) && $_REQUEST['act'] == 'app2') {
    $emp = $_REQUEST['emp'];
    $date = $_REQUEST['date'];

    mysql_query("UPDATE table_otherbenefits SET Sublau_Status = 2 WHERE Emp_no = '$emp' AND Sublau_date = '$date'");
}
?>
...
<html lang="en-US">
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" type="text/css"><link href="https://cdn.datatables.net/fixedcolumns/3.2.4/css/fixedColumns.dataTables.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="theme-red" style="background-color: #e0e0e0;">
        <!-- Page Loader -->
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div style="background-color: #fff; min-height: 80vh;" class="body">
                                <label for="bene">Choose a Benefits: </label>
                                <select id="bene">
                                    <option value="">-- Choose a Benefits --</option>
                                    <option value="lon">Longevity Pay</option>
                                    <option value="haz">Hazard Pay</option>
                                    <option value="sublau">Subsistence and Laundry allowance</option>
                                </select>
                                <br><br>
                                <?php
                                $datee = $_SESSION['INTRA_DATE_OB'];
                                ?>
                                <div id="lon">
                                    <?php
                                    echo '<p style="font-weight: bold; font-size: 18px; text-align: center;"> Longevity Pay - ' . date('F, Y', strtotime($datee)) . '</p><br>';
                                    ?>
                                    <table id="example" class="example table-bordered stripe row-border order-column" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysql_query("SELECT A.*, B.* FROM table_otherbenefits A"
                                                    ...
                                                    . "     ON A.Emp_no = B.Employee_Id WHERE Date_covered = '$datee' AND Longevity_Status BETWEEN 1 AND 2");
                                            while ($row = mysql_fetch_array($query)) {
                                                ...
                                                for ($i = 0; $i < $londeduCount; $i++) {
                                                    ...
                                                    if ($lonotherDeduc != "") {
                                                        echo '<b>' . $londed1[1] . '</b> - ' . $lonotherDeduc . '<br>';
                                                    } else {
                                                        echo '';
                                                    }
                                                }
                                                echo'</td>';
                                                echo '<td>';
                                                if ($row['Longevity_Status'] == '2') {
                                                    echo '<i class="material-icons" style="color: green;">verified_user</i>';
                                                } elseif ($row['Longevity_Status'] == '1') {
                                                    echo '<a class="confirmme btn bg-green btn-xs waves-effect" data-toggle="tooltip" data-placement="top" title="Confirm" name="confirm" data-emp="' . $row['Emp_no'] . '" data-date="' . $row['Longevity_date'] . '" target="_blank"><i class="material-icons">done</i></a>&nbsp;';
                                                    echo '<a class="btn bg-teal btn-xs waves-effect" data-toggle="tooltip" data-placement="top" title="Edit" href="EditOtherBenefits.php?emp=' . $row['Emp_no'] . '&date=' . $row['Longevity_date'] . '&cat=lon" target="_blank"><i class="material-icons">mode_edit</i></a>';
                                                }
                                                echo '</td>';
                                                echo '</tr>';
                                            }
                                ...
                                <div id="haz">
                                    ...
                                    echo '<p style="font-weight: bold; font-size: 18px; text-align: center;"> Longevity Pay - ' . date('F, Y', strtotime($datee)) . '</p><br>';
                                    ?>
                                    <table id="example1" class="example table-bordered stripe row-border order-column" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Date Covered</th>
                                        ...
                                        <tbody>
                                            ...
                                            $query1 = mysql_query("SELECT A.*, B.* FROM table_otherbenefits A"
                                                    . " LEFT JOIN table_empinfo B"
                                                    . "     ON A.Emp_no = B.Employee_Id WHERE Date_covered = '$datee' AND Hazard_Status BETWEEN 1 AND 2");
                                            while ($row = mysql_fetch_array($query1)) {
                                                ...
                                                for ($i = 0; $i < $hazdeduCount; $i++) {
                                                    ...
                                                    if ($hazotherDeduc != "") {
                                                        echo '<b>' . $hazded1[1] . '</b> - ' . $hazotherDeduc . '<br>';
                                                    } else {
                                                        echo '';
                                                    }
                                                }
                                                echo '</td>';
                                                echo '<td>';
                                                if ($row['Hazard_Status'] == '2') {
                                                    echo '<i class="material-icons" style="color: green;">verified_user</i>';
                                                } elseif ($row['Hazard_Status'] == '1') {
                                                    echo '<a class="confirmme btn bg-green btn-xs waves-effect" data-toggle="tooltip" data-placement="top" title="Confirm" name="confirm" data-emp="' . $row['Emp_no'] . '" data-date="' . $row['Hazard_date'] . '" target="_blank"><i class="material-icons">done</i></a>&nbsp;';
                                                    echo '<a class="btn bg-teal btn-xs waves-effect" data-toggle="tooltip" data-placement="top" title="Edit" href="EditOtherBenefits.php?emp=' . $row['Emp_no'] . '&date=' . $row['Hazard_date'] . '&cat=haz" target="_blank"><i class="material-icons">mode_edit</i></a>';
                                                }
                                                echo '</td>';
                                                echo '</tr>';
                                            }
                                ...
                                <div id="sublau">
                                    ...
                                    echo '<p style="font-weight: bold; font-size: 18px; text-align: center;"> Longevity Pay - ' . date('F, Y', strtotime($datee)) . '</p><br>';
                                    ?>
                                    <table id="example2" class="example table-bordered stripe row-border order-column" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Date Covered</th>
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = mysql_query("SELECT A.*, B.* FROM table_otherbenefits A"
                                                    . " LEFT JOIN table_empinfo B"
                                                    . "     ON A.Emp_no = B.Employee_Id WHERE Date_covered = '$datee' AND Sublau_Status BETWEEN 1 AND 2");
                                            while ($row = mysql_fetch_array($query2)) {
                                                ...
                                                echo '<td>' . $row['Subsistence_allowance'] . '</td>';
                                                echo '<td>' . $row['Laundry_allowance'] . '</td>';
                                                echo '<td>';
                                                ...
                                                for ($i = 0; $i < $sublaudeduCount; $i++) {
                                                    ...
                                                    if ($sublauotherDeduc != "") {
                                                        echo '<b>' . $sublauded1[1] . '</b> - ' . $sublauotherDeduc . '<br>';
                                                    } else {
                                                        echo '';
                                                    }
                                                }
                                                echo '</td>';
                                                echo '<td>';
                                                if ($row['Sublau_Status'] == '2') {
                                                    echo '<i class="material-icons" style="color: green;">verified_user</i>';
                                                } elseif ($row['Sublau_Status'] == '1') {
                                                    echo '<a class="confirmme btn bg-green btn-xs waves-effect" data-toggle="tooltip" data-placement="top" title="Confirm" name="confirm" data-emp="' . $row['Emp_no'] . '" data-date="' . $row['Sublau_date'] . '" target="_blank"><i class="material-icons">done</i></a>&nbsp;';
                                                    echo '<a class="btn bg-teal btn-xs waves-effect" data-toggle="tooltip" data-placement="top" title="Edit" href="EditOtherBenefits.php?emp=' . $row['Emp_no'] . '&date=' . $row['Sublau_date'] . '&cat=sublau" target="_blank"><i class="material-icons">mode_edit</i></a>';
                                                }
                                                echo '</td>';
                                                echo '</tr>';
                                            }
    ...
    <script language="javascript">
        $(document).ready(function () {
            ...
            $('.example').on('click', 'a.confirmme', function (e) {
                ...
                swal({
                    title: "Are you sure?",
                    text: "Finalized the verification",
                    type: "warning",
                ...
                function () {
                    ...
                    if ($('#bene').val() === 'lon') {
                        $.ajax({
                            type: 'POST',
                            url: 'VerifiedOBData.php?emp=' + emp + '&date=' + date + '&act=app',
                            success: function () {
                                $('.example').attr("id");
                                a.closest('td').html('<i class="material-icons" style="color: green;">verified_user</i>');
                                swal("Successful!", "The verification is complete", "success");
                            }
                        });
                    } else if ($('#bene').val() === 'haz') {
                        $.ajax({
                            type: 'POST',
                            url: 'VerifiedOBData.php?emp=' + emp + '&date=' + date + '&act=app1',
                            success: function () {
                                $('.example').attr("id");
                                a.closest('td').html('<i class="material-icons" style="color: green;">verified_user</i>');
                                swal("Successful!", "The verification is complete", "success");
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'VerifiedOBData.php?emp=' + emp + '&date=' + date + '&act=app2',
                            success: function () {
                                $('.example').attr("id");
                                a.closest('td').html('<i class="material-icons" style="color: green;">verified_user</i>');
                                swal("Successful!", "The verification is complete", "success");
