...
if (isset($_POST['btnSubmit'])) {
    ...
    $sel = mysql_query("SELECT MAX(Transaction_no) as maxTran FROM table_atapplication");
    $row2 = mysql_fetch_assoc($sel);
    $nextTran = $row2['maxTran'] + 1;
    $tracno = str_pad($nextTran, 4, 0, STR_PAD_LEFT);
    
    mysql_query("INSERT INTO table_atapplication VALUES(NULL,'$pdsid','$d1','$d2','$d3','$d4','$tracno')");
    ...
    header("Location: ATApplicationList.php");
}
?>
                        ...
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" class="body">
                                <div style="min-height: 77vh;right: 0; width: auto; padding: 40px;">
                                    ...
                                    <form action="ApplicationForAT.php" method="post" id="sweet">
                                        <div style="width: 70%; margin:0 auto;">
                                            ...
                                            <div class="well" style="background-color: white; padding-left: 50px;">
                                                ...
                                                <div class="form-group" style="width: 300px;">
                                                    <div class="form-line">
                                                        <input type="text" name="d2" id="d2" class="form-control" placeholder="Input Here..." required/>
                                                    </div>
                                                </div><br>
