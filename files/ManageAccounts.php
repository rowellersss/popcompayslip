...
if (isset($_REQUEST['id']) && $_REQUEST['act'] == 'del') {
    ...
    $id = $_REQUEST['id'];
    mysql_query("Delete from table_empacc where Emp_Id = '$id'");
    echo '<script>';
    echo 'alert("Successful!")';
    echo '</script>';
}

if (isset($_REQUEST['id']) && $_REQUEST['act'] == 'disapp') {

    $id = $_REQUEST['id'];
    mysql_query("Update table_empinfo set Approve = 'No' where Employee_Id = '$id'");
    echo '<script>';
    echo 'alert("Successful!")';
    echo '</script>';
}
...
if (isset($_REQUEST['id']) && $_REQUEST['act'] == 'app') {
    ...
    $id = $_REQUEST['id'];
    mysql_query("Update table_empinfo set Approve = 'Yes' where Employee_Id = '$id'");
    echo '<script>';
    echo 'alert("Successful!")';
    echo '</script>';

//    $eid = $_SESSION['INTRA_EMP_ID'];
//    $que = mysql_query("select * from table_empinfo where Employee_Id = '$eid'");
//    $row1 = mysql_fetch_assoc($que);
//    $email = $row1['Email'];
//    $fname = ucfirst($row1['Firstname']);
//    $lname = ucfirst($row1['Lastname']);
//
//    $mail = new PHPMailer;
//    $mail->isSMTP();                                      // Set mailer to use SMTP
//    $mail->Host = 'liham.dict.gov.ph';  // Specify main and backup SMTP servers
//    $mail->SMTPAuth = true;                               // Enable SMTP authentication
//    $mail->Username = 'itdmu@popcom.gov.ph';                 // SMTP username
//    $mail->Password = '502011p0pc0m';                           // SMTP password
//    $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
//    $mail->Port = 465;
//    $mail->From = 'itdmu@popcom.gov.ph';
//    $mail->FromName = 'ITDMU';
...
//                        Your account has been approved, you can now Sign in with your account. Your password is 12345.";
...
//    } else {
//        echo '<script language="javascript">';
//        echo 'alert("Email has been sent successfuly!")';
//        echo '</script>';
//    }
}

if (isset($_POST['UPsubmit'])) {
    $d1 = mysql_real_escape_string($_POST['UPfname']);
    $d2 = mysql_real_escape_string($_POST['UPmname']);
    $d3 = mysql_real_escape_string($_POST['UPlname']);
    $d4 = mysql_real_escape_string($_POST['UPuname']);
    $d5 = mysql_real_escape_string($_POST['UPpos']);
    $d6 = mysql_real_escape_string($_POST['UPdiv']);

    echo $d1 . '<br>' . $d2 . '<br>' . $d3 . '<br>' . $d4 . '<br>' . $d5 . '<br>' . $d6;
}
?>
                        ...
                        <div class="card">
                            ...
                            <div style="background-color: #fff; min-height: 80vh;" class="body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-1">
                                        <button type="button" class="btn btn-primary waves-effect m-r-20" data-toggle="modal" data-target="#defaultModal">CREATE NEW</button>
                                    </div>
                                </div>
                                <table id="qualificationTable" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr>
                                            <!--<th>Employee ID</th>-->
                                            <th>Name</th>
                                    ...
                                    <tbody><!--<td>' . $row['Employee_Id'] . '</td>-->
                                        <?php
                                        $query2 = mysql_query("select table_empinfo.*, table_empacc.*, table_position.*, table_division.* from table_empinfo"
                                                . "              join table_empacc"
                                                . "                 on table_empacc.Emp_Id = table_empinfo.Employee_Id "
                                                . "              left join table_position"
                                                . "                 on table_position.position_id = table_empinfo.Position"
                                                . "              left join table_division"
                                                . "                 on table_division.division_id = table_position.division_id order by Employee_Id asc");
                                        while ($row = mysql_fetch_array($query2)) {
                                            ...
                                            $html = '<tr>'
                                                    ...
                                                    . '<td>';
                                            if ($row['Approve'] == 'Yes') {
                                                $html .= '<a data-id="' . $row['Employee_Id'] . '" class="deacme btn bg-deep-orange btn-xs waves-effect">Deactivate</a>';
                                            } elseif ($row['Approve'] == 'No') {
                                                $html .= '<a data-id="' . $row['Employee_Id'] . '" class="acme btn bg-green btn-xs waves-effect">Activate</a>';
                                            }
                                            $html .= '&nbsp;<a data-id="' . $row['Employee_Id'] . '" class="deleteme btn bg-red btn-xs waves-effect">Delete</a>';

                                            $html .= '&nbsp;<a data-toggle="modal" data-target="#UPdefaultModal" class="btn bg-teal btn-xs waves-effect">Update</a>';
                                            $html .= '</td></tr>';
                                            echo $html;
                                        }
                                        ?>
                                ...
                                <div class="modal fade" id="UPdefaultModal" tabindex="-1" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        <div class="alert alert-success hidden" role="alert" id="mess"></div>
                                                        <div class="alert alert-danger hidden" role="alert" id="mess2"></div><br>
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" name="UPfname" class="form-control" required>
                                                                <label class="form-label">First Name</label>
                                                            </div>
                                                        </div><br>
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" name="UPmname" class="form-control" required>
                                                                <label class="form-label">Middle Name</label>
                                                            </div>
                                                        </div><br>
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" name="UPlname" class="form-control" required>
                                                                <label class="form-label">Last Name</label>
                                                            </div>
                                                        </div><br>
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" name="UPuname" class="form-control" required>
                                                                <label class="form-label">User Name</label>
                                                            </div>
                                                        </div><br>
                                                            <select name="UPpos" style="width: 900px;">
                                                                <?php
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" name="UPsubmit" value="CREATE" class="btn btn-link waves-effect">CREATE</button>
                                                        <button type="submit" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                                                    </div>
                                                </form>
                                ...
                                <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="smallModalLabel">Create New Account</h4>
                                            </div>
                                            <br>
                                            <div class="modal-body">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" name="submit" id="submit" value="CREATE" class="btn btn-link waves-effect">CREATE</button>
                                                        <button type="submit" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
                                                    </div>
                                                </form>
        ...
        $(document).ready(function () {
            ...
            $('#qualificationTable').on('click', 'a.deleteme', function (e) {
                ...
                function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ManageAccounts.php?id=' + delid + '&act=del',
                        success: function () {
            ...
            $('#qualificationTable').on('click', 'a.deacme', function (e) {
                e.preventDefault();
                var a = $(this);
                var delid = $(this).attr('data-id')
                ...
                function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ManageAccounts.php?id=' + delid + '&act=disapp',
                        success: function () {
            ...
            $('#qualificationTable').on('click', 'a.acme', function (e) {
                e.preventDefault();
                var a = $(this);
                var delid = $(this).attr('data-id')
                ...
                function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ManageAccounts.php?id=' + delid + '&act=app',
                        success: function () {
