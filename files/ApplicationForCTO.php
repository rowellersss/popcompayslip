...
if (isset($_POST['btnBack'])) {
    header("Location: CTOApplicationList.php");
}
...
if (isset($_POST['btnSubmit'])) {
    ...
    $sel = mysql_query("SELECT MAX(Transaction_no) as maxTran FROM table_ctoapplication");
    $row2 = mysql_fetch_assoc($sel);
    $nextTran = $row2['maxTran'] + 1;
    $tracno = str_pad($nextTran, 4, 0, STR_PAD_LEFT);
    
    mysql_query("INSERT INTO table_ctoapplication VALUES(NULL,'$pdsid','$d1','$d2','$d3','$d4','$tracno')");
                        ...
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" class="body">
                                <div style="min-height: 77vh;right: 0; width: auto; padding: 40px;">
                                    ...
                                    <form action="ApplicationForCTO.php" method="post" id="sweet">
                                        <div style="width: 70%; margin:0 auto;">
                                            ...
                                            <div class="well" style="background-color: white; height: 80px;">
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text" class="datepicker form-control" id="datePicker" name="d1" placeholder="Please choose a date..." required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="well" style="background-color: white; padding-left: 50px;">
                                                ...
                                                <p style="font-weight: bold;">Number of overtime Hours on the following date/s as per photocopy of DTR attached</p>

                                                <div class="form-group" style="width: 300px;">
                                                    <div class="form-line">
                                                        <input type="text" name="d2" class="form-control" placeholder="Input Here..." required/>
                                                    </div>
                                                </div><br>

                                                <p style="font-weight: bold;">Total number of overtime hours<br>(must be divisible by 4)</p>

                                                <div class="form-group" style="width: 300px;">
                                                    <div class="form-line">
                                                        <input type="text" name="d3" class="form-control" placeholder="Input Here..." required/>
                                                    </div>
                                                </div><br>

                                                <p style="font-weight: bold;">Time-off applied on the following date/s</p>

                                                <div class="form-group" style="width: 300px;">
                                                    <div class="form-line">
                                                        <input type="text" name="d4" class="form-control" placeholder="Input Here..." required/>
                                                    </div>
                                                </div><br>
                                                <input type="submit" name="btnSubmit" value="Create" class="btn bg-indigo waves-effect">
                                                <a href="CTOApplicationList.php" class="btn bg-blue waves-effect">Back</a><br><br>
                                            </div>
                                        </div>
                    ...
                    if (isset($_SESSION['INTRA_INDICATOR']) && $_SESSION['INTRA_INDICATOR'] == 'true') {
                        ...
                        <script>
                            $(document).ready(function () {
                                swal("Successful!", "Application for CTO has been successfully created!", "success");
                            })
                        </script>
                        <?php
                    }
