                        ...
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" class="body">
                                <div style="min-height: 77vh; right: 0; width: auto; padding: 40px;">
                                    <form action="ManageServiceReqDone.php" method="post">
                                        <div class="row clearfix">
                                        ...
                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable ">
                                            ...
                                            <tbody >
                                                ...
                                                if (isset($_POST['process'])) {
                                                    ...
                                                    if (empty($d1) && empty($d2) && empty($d3) && !empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Finished' AND Category = '$d4' order by Id asc");
                                                    }

                                                    if (!empty($d1) && !empty($d2) && !empty($d3) && !empty($d3)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Finished' AND DateofReq BETWEEN '$start' AND '$end' AND DivUnitRPO = '$d3' AND Category = '$d4' order by Id asc");
                                                    }
                                                    ...
                                                    if (empty($d1) && empty($d2) && !empty($d3) && !empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Finished' AND DivUnitRPO = '$d3' AND Category = '$d4' order by Id asc");
                                                    }

                                                    if (!empty($d1) && !empty($d2) && empty($d3) && !empty($d4)) {
                                                        $query2 = mysql_query("select * from table_servicereq where Status = 'Finished' AND DateofReq BETWEEN '$start' AND '$end' AND Category = '$d4' order by Id asc");
                                                    }

                                                    if (empty($_POST['start']) && empty($_POST['end']) && empty($_POST['div']) && empty($_POST['cat'])) {
                                                ...
                                                if (!isset($_POST['start']) && !isset($_POST['end']) && !isset($_POST['div']) && !isset($_POST['cat'])) {
                                                    $query2 = mysql_query("select * from table_servicereq where Status = 'Finished' order by Id asc");
                                                }
                                                ...
                                                while ($row = mysql_fetch_array($query2)) {
                                                    ...
                                                    echo '<tr><td>' . ucwords($row['ReqBy']) . '</td><td>' . $date . '</td><td>' . $row['DivUnitRPO'] . '</td>'
                                                    . '<td style="max-width: 200px;">' . $row['DescOfReq'] . '</td><td><b style="color: ' . $color . '">' . $row['Category'] . '</b></td></tr>';
                                                }
                                                ?>
                                            </tbody>
                                        </table>
