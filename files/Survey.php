...
if (isset($_POST['submit'])) {
    ...
    $d2 = $_POST['comment'];
    $id = $_REQUEST['Id'];
    mysql_query("Update table_servicereq set Rating = '$d1', Comment = '$d2' where Id = '$id'");
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" class="body">
                                <div style="height: 650px; right: 0; width: auto; padding: 40px;">
                                    <form method="post" action="<?php echo 'Survey.php?Id=' . $_GET['Id']; ?>">
                                        ...
                                        <h2 class="card-inside-title">Overall Satisfactory Rating</h2>

                                        <input name="sur" type="radio" id="radio_1" value="Very Satisfied" <?php if ($row2['Rating'] == "Very Satisfied") {
                                            echo 'checked';
                                        } ?>/>
                                        <label for="radio_1">Very Satisfied</label>
                                        <input name="sur" type="radio" id="radio_2" value="Satisfied" <?php if ($row2['Rating'] == "Satisfied") {
                                            echo 'checked';
                                        } ?>/>
                                        <label for="radio_2">Satisfied</label>
                                        <input name="sur" type="radio" id="radio_3" value="Fine" <?php if ($row2['Rating'] == "Fine") {
                                            echo 'checked';
                                        } ?>/>
                                        <label for="radio_3">Fine</label>
                                        <input name="sur" type="radio" id="radio_4" value="Dissatisfied" <?php if ($row2['Rating'] == "Dissatisfied") {
                                            echo 'checked';
                                        } ?>/>
                                        <label for="radio_4">Dissatisfied</label>
                                        <input name="sur" type="radio" id="radio_5" value="Very Dissatisfied" <?php if ($row2['Rating'] == "Very Dissatisfied") {
                                            echo 'checked';
                                        } ?>/>
                                        <label for="radio_5">Very Dissatisfied</label>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <textarea name="comment" cols="50" rows="10" class="form-control no-resize" placeholder="Please type what you want..."><?php echo $row2['Comment']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
