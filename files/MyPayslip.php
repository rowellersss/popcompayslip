...
$id = mysql_real_escape_string($_SESSION['INTRA_EMP_ID']);
$dateCovered = explode('-', $_REQUEST['Mdate']);
$yearCov = $dateCovered[0];
$monthCov = $dateCovered[1];
$cov = $yearCov.'-'.$monthCov;
$checkGP = mysql_query("SELECT * FROM table_payslip WHERE Emp_no = '$id' AND year_covered = '$yearCov' AND month_covered = '$monthCov'");
$checkSP = mysql_query("SELECT * FROM table_specialpayroll WHERE Emp_no = '$id' AND year_covered = '$yearCov' AND month_covered = '$monthCov'");
$checkRowGP = mysql_num_rows($checkGP);
$checkRowSP = mysql_num_rows($checkSP);
// print_r($checkRowGP);exit;
...
if (!isset($_REQUEST['empid'])) {
    ...
    if (isset($_REQUEST['Mdate'])) {
        ...
        if($checkRowGP == 1 AND $checkRowSP == 0){
        ...
        }elseif($checkRowGP == 0 AND $checkRowSP == 1){
            $sql = mysql_query("SELECT * FROM table_specialpayroll WHERE Emp_no = '$empid' AND year_covered = '$year' AND month_covered = '$month' AND verified = 'Yes'");
        }
        $sql2 = mysql_query("SELECT * FROM table_otherbenefits WHERE Emp_no = '$empid' AND Pera_date LIKE '$date_covered%' AND Longevity_date LIKE '$date_covered%' ");
        ...
        $sql2 = mysql_query("SELECT Date_covered, Longevity_date, Longevity_Status, Hazard_date, Hazard_Status,
                            ...
                            WHERE Emp_no = '$empid'
                            AND Longevity_date LIKE '$year[0]%'
                            AND Hazard_date LIKE '$year[0]%'
                            AND Sublau_date LIKE '$year[0]%'");
...
if($checkRowGP == 1 AND $checkRowSP == 0){
    ...
    $dc = explode(" ", $row['In_date']);
    $mon = date("F", strtotime($dc[0]));
    $yearr = $dc[2];
    $dc2 = explode(" ", $row['In_date2']);
    $mon2 = date("F", strtotime($dc2[0]));
}
...
//---------------------- FIRST COPY --------------------------//
    ...
    if (isset($_REQUEST['cat']) && $_REQUEST['cat'] == 'Benefits') {
        ...
        $html .= '</tr><tr>';
        $html .= '<td colspan="1" class="tdfontt">P.E.R.A:</td><td class="tdfontt"></td><td></td><td class="tdfontt" style="text-align: right;">' . $row2['pera'] . '</td>';
        $html .= '</tr><tr>';
        if(isset($_REQUEST['Mdate']))
        {
...
//------------------------------------- UNOFFICIAL PAYSLIP -------------------------------------//
    ...
    if($checkRowGP == 1 AND $checkRowSP == 0) //unofficial payslip GP
    {
    ...
    elseif($checkRowGP == 0 AND $checkRowSP == 1) // unofficial payslip SP
    {
        $html .= '<title>Payslip</title>';
        $html .= '<style>';
        $html .= 'html, body {'
        ...
        if (isset($_REQUEST['cat']) && $_REQUEST['cat'] == 'Benefits') {
            ...
            else
            {
                ...
                $html .= '<tr style="border: 2px solid;">';
                $html .= '<td class="tdfont" colspan="2">Compensations Salary</td><td colspan="2" style="text-align: right; border: 2px solid;"></td>';
                $html .= '</tr>';

                if(isset($_REQUEST['Mdate']))
                {
                    $html .= '<tr style="border: 2px solid;">';
                    $html .= '<td class="tdfont" colspan="2" style="border: 2px solid;">&nbsp;&nbsp;&nbsp;&nbsp;Salary 1st cut off</td>';
                    $html .= '<td class="tdfont" colspan="2" style="text-align: right;">' . str_replace(' ', '', $row['Adj_periodcovered']) . '</td>';
                    $html .= '</tr>';
                    $html .= '<tr style="border: 2px solid;">';
                    $html .= '<td class="tdfont" colspan="2" style="border: 2px solid;">&nbsp;&nbsp;&nbsp;&nbsp;Salary 2nd cut off</td>';
                    $html .= '<td class="tdfont" colspan="2" style="text-align: right;">' . str_replace(' ', '', $row['Adj_periodcovered2']) . '</td>';
                    $html .= '<tr>';
                }

                $pera1 = str_replace(',','', $row['Pera1']);
                $pera2 = str_replace(',','', $row['Pera2']);
                $peraSP = $pera1 + $pera2;
                if ($row['Pera1'] != "" && $row['Pera1'] != 0.00 && $row['Pera2'] != "" && $row['Pera2'] != 0.00) {
                    $html .= '<tr style="border: 2px solid;"><td class="tdfont" colspan="2">P.E.R.A</td><td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . number_format(str_replace(' ', '', (str_replace(',', '', $peraSP))), 2) . '</td></tr>';
                }
                if ($row['Lwop'] != "" && $row['Lwop'] != 0) {
                    $html .= '<tr style="border: 2px solid;"><td class="tdfont" colspan="2">LWOP</td><td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['Lwop']))), 2) . '</td></tr>';
                }
                if ($row['Salaries_withtax'] != "" && $row['Salaries_withtax'] != 0) {
                    $html .= '<tr style="border: 2px solid;"><td class="tdfont" colspan="2">Withholding Tax</td><td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['Salaries_withtax']))), 2) . '</td></tr>';
                }
                ...
                if ($row['GSIS_calamityloan'] != "" && $row['GSIS_calamityloan'] != 0) {
                    $html .= '<tr style="border: 2px solid;"><td class="tdfont" colspan="2">GSIS - Calamity Loan</td><td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_calamityloan']))), 2) . '</td></tr>';
                }
                if ($row['GSIS_emergloan'] != "" && $row['GSIS_emergloan'] != 0) {
                    $html .= '<tr style="border: 2px solid;"><td class="tdfont" colspan="2">GSIS - Emergency Loan</td><td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['GSIS_emergloan']))), 2) . '</td></tr>';
                }
                ...
                if ($row['A/R_pldt'] != "" && $row['A/R_pldt'] != 0) {
                    $html .= '<tr style="border: 2px solid;"><td class="tdfont" colspan="2">A/R PLDT</td><td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['A/R_pldt']))), 2) . '</td></tr>';
                }
                if ($row['COPEA_dues'] != "" && $row['COPEA_dues'] != 0) {
                    $html .= '<tr style="border: 2px solid;"><td class="tdfont" colspan="2">COPEA Dues</td><td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['COPEA_dues']))), 2) . '</td></tr>';
                }
                if ($row['COPEA_loan'] != "" && $row['COPEA_loan'] != 0) {
                    $html .= '<tr style="border: 2px solid;"><td class="tdfont" colspan="2">COPEA Loan</td><td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . number_format(str_replace(' ', '', (str_replace(',', '', $row['COPEA_loan']))), 2) . '</td></tr>';
                }
                if (($row['PMPC_capital'] != "" && $row['PMPC_capital'] != 0) || ($row['PMPC_loan'] != "" && $row['PMPC_loan'] != 0)) {
                    // $html .= '<tr style="border: 2px solid;"><td class="tdfont">PMPC</td><td></td></tr>';
                }
                ...
                {
                    $html .= '<tr style="border: 2px solid;">';
                    $html .= '<td class="tdfont" colspan="2">1st cut-off Deduction</td>';
                    $html .= '<td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . str_replace(' ', '', $row['Total_deduction']) . '</td>';
                    $html .= '</tr>';
                    $html .= '<tr style="border: 2px solid;">';
                    $html .= '<td class="tdfont" colspan="2">2nd cut-off Deduction</td>';
                    $html .= '<td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . str_replace(' ', '', $row['Total_deduction2']) . '</td>';
                    $html .= '<tr>';
                }
            //$html .= '<tr><td style="border-top: 2px solid black;"><b>Net Amount Due</b></td><td style="border-top: 2px solid black;"><b>' . number_format(str_replace(' ', '', $row['Net_amount']), 2) . '</b></td></tr>';
                ...
                if(isset($_REQUEST['Adate'])){
                    ...
                    $mc1 = explode(" ", $row['In_date']);
                    $mc2 = explode(" ", $row['In_date2']);
                    $html .= '<td class="tdfont" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;' . $mc1[0] . ' ' . $mc1[1] . ' - ' . $mc1[3] . '</td>';
                    $html .= '<td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . str_replace(' ', '', $row['Net_amount']) . '</td>';
                    $html .= '</tr>';
                    $html .= '<tr style="border: 2px solid;">';
                    $html .= '<td class="tdfont" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;' . $mc2[0] . ' ' . $mc2[1] . ' - ' . $mc2[3] . '</td>';
                    $html .= '<td class="tdfont" colspan="2" style="text-align: right; border: 2px solid;">' . str_replace(' ', '', $row['Net_amount2']) . '</td>';
                }
                $html .= '</tr>';
                $html .= '<tr style="border: 2px solid;">';
                ...
                $grTotal = $lonPay1 + $hazPay1 + $sLpay1 + $bonusesTotal;
                //-----------------Other Bonuses/Benefits----------------//
                if($_REQUEST['Mdate'] OR $_REQUEST['Adate']){
                    $html .= '</tr><tr style="border: 2px solid;">';
                    $html .= ($bonusrow != 0 ? '<td colspan="4" class="tdfont">Others:</td>' : '');
