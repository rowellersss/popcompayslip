...
if (isset($_REQUEST['Id']) && $_REQUEST['act'] == 'ong') {
    ...
    $id = $_REQUEST['Id'];
    mysql_query("Update table_servicereq set Status = 'Ongoing' where Id = '$id'");
}
                        ...
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" class="body">
                                <div style="min-height: 77vh; right: 0; width: auto; padding: 40px;">
                                    <form action="ManageServiceReqFin.php" method="post">
                                        <div class="row clearfix">
                                        ...
                                        <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                            ...
                                            <tbody >
                                                ...
                                                if (isset($_POST['process'])) {
                                                    ...
                                                    if (empty($_POST['start']) && empty($_POST['end']) && empty($_POST['div'])) {
                                                ...
                                                if (!isset($_POST['start']) && !isset($_POST['end']) && !isset($_POST['div'])) {
                                                    $query2 = mysql_query("select * from table_servicereq where Status = 'Finished' order by Id asc");
                                                }
                                                ...
                                                while ($row = mysql_fetch_array($query2)) {
                                                    $date = date('M d, Y', strtotime($row['DateofReq']));
                                                        ...
                                                        . '<td style="max-width: 200px;">' . $row['DescOfReq'] . '</td><td>' . $row['AcTakenBy'] . '</td><td style="color: orange;"><b>' . $row['Status'] . '</b></td>'
                                                        . '<td><a title="View Request Form" class="remove" href="../RequestForm.php?Id=' . $row['Id'] . '&act=set"><i class="material-icons">visibility</i></a></td></tr>';
