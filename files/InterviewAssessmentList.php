                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <h2>Interview Assessment List</h2>
                                            ...
                                            while ($row = mysql_fetch_array($query)) {
                                                ...
                                                if ($row['Interview_status'] == 1) {
                                                    if (isset($row['quaPos'])) {
                                                        ...
                                                        echo '<td>';
                                                        echo '  <a href="InterviewAssessmentForm.php?id=' . $row['PDS_ID'] . '" class="btn bg-teal btn-xs waves-effect" target="_blank">Assess</a>';
                                                        echo '  <a href="ViewInterviewAssessmentForm.php?id=' . $row['PDS_ID'] . '" class="btn bg-cyan btn-xs waves-effect" target="_blank">View</a>';
                                                        echo '</td>';
                                                        echo '</tr>';
                                                    } else {
                                                        echo '<tr style="font-size: 13px;">';
