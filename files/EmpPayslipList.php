                        ...
                        <div class="card">
                            ...
                            <div style="min-height: 80vh; background-color: #fff;" id="bodyy" class="body">
                                <div style="height: 730px; right: 0; width: auto; padding: 40px;">
                                    ...
                                    <div id="sap">
                                        <form action="EmpPayslipList.php?id=<?php echo $_GET['id']; ?>" method="post" id="paySlipForm">
                        ...
                        if (numcount == 0) {
                            ...
                            if ($('#year').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    ...
                                    newTab.location = "ViewPayslip.php?cat=" + $('#cat').val() + "&Mdate=" + $('#year').val() + "-" + $('#month').val() + "-01&id=" + <?php echo $_GET['id']; ?>;
                                }
                            } else if ($('#year2').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    newTab.close();
                                    ...
                                    //ViewPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    newTab.location = "ViewPayslip.php?cat=" + $('#cat').val() + "&Adate=" + $('#year2').val() + "&id=" + <?php echo $_GET['id']; ?>;
                                }
                            } else if ($('#year3').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    newTab.close();
                                    ...
                                    //ViewPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    newTab.location = "ViewPayslip.php?cat=" + $('#cat').val() + "&Ydate=" + $('#year3').val() + "-01-01&Ydate2=" + $('#year3').val() + '-' + $('#month3').val() + "-01&id=" + <?php echo $_GET['id']; ?>;
                                }
                            } else if ($('#year4').val() !== '') {
                                if (passw !== $.md5($('input[name=ac]').val())) {
                                    newTab.close();
                                    ...
                                    //ViewPayslip.php?date=" + $('select[name=month]').val() + " 1-15, 2017
                                    newTab.location = "ViewPayslip.php?cat=" + $('#cat').val() + "&Rdate=" + $('#year4').val() + '-' + $('#month4').val() + '-01&Rdate2=' + $('#year4').val() + '-' + $('#month41').val() + '-01&id=' + <?php echo $_GET['id']; ?>;
                                }
                            }
