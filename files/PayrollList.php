...
<html lang="en-US">
                            ...
                            <div style="background-color: #fff; min-height: 80vh;" class="body">
                                ...
                                <form id="select-date" method="post">
                                    ...
                                    <select name="date" id="date" required>
                                        <option> </option>
                                        <?php
                                        $query = mysql_query("SELECT * FROM table_payslip GROUP BY month_covered");

                                        while ($row = mysql_fetch_array($query)) {
                                            echo '<option value="' . $row['year_covered'] . '-' . $row['month_covered'] . '">' . date('F', mktime(null, null, null, $row['month_covered'], 1)) . ', ' . $row['year_covered'] . '</option>';
                                        }
                                        ?>
                                    </select>&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="selectDate">
                                    <input type="submit" class="btn bg-cyan btn-md waves-effect" value="Submit">
                                </form>
                            </div>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">CHOOSE PAYROLL</h4>
                    </div>
                    <form id="view-payroll" method="post">
                        <div class="modal-body" style="margin: 60px 40px 20px 40px;">
                            <div class="row clearfix">
                                <div style="text-align: left;" class="col-lg-3 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                    <label for="email_address_2">Payroll</label>
                                </div>
                                <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <select name="payroll" id="date" required>
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="btnView" class="btn btn-link waves-effect">VIEW</button>
    ...
    <script language="javascript">
        $(document).ready(function () {
            ...
            $('#select-date').submit(function(e){
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        $('#payroll-modal').find('input[name="date"]').val(result);
            ...
            $('#view-payroll').submit(function(e){
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        if(result == 'GUpGz2C*b+yt')
                        {
                            newTab.location = "ViewPayroll.php?date=" + date;
                        }
                        else if(result == 'XYNLDLNd7ts;')
                        {
                            newTab.location = "ViewBenefits.php?benefits=longevity_pay&date=" + date;
                        }
                        else if(result == 'SAF+]>3M57{;')
                        {
                            newTab.location = "ViewSpecialPayroll.php?date=" + date;
                        }
